...
module.exports.custom = {
  ...
  ***************************************************************************/
  githubRepoMaintainersByPath: {// fleetdm/fleet
    ...
    '.github/workflows/deploy-vulnerability-dashboard.yml': ['eashaw','mikermcneil'],// (website deploy script)
    '.github/workflows/test-vulnerability-dashboard-changes.yml': ['eashaw','mikermcneil'],//« website CI test script
