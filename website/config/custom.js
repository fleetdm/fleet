...
module.exports.custom = {
  ...
  ***************************************************************************/
  githubRepoDRIByPath: {// fleetdm/fleet
    ...
    'docs/01-Using-Fleet/standard-query-library/standard-query-library.yml': ['mikermcneil','zhumo','eashaw','lucasmrod','sharon-fdm','artemist-work'],// (standard query library)
    'schema': ['zhumo','eashaw','zwass','mikermcneil','lucasmrod','sharon-fdm','artemist-work'],// (Osquery table schema)
  },
