...
module.exports.bootstrap = async function() {
  ...
  await User.createEach([
    { emailAddress: 'admin@example.com', firstName: 'Ryan', lastName: 'Dahl', organization: 'Golaith Industries', isSuperAdmin: true, password: await sails.helpers.passwords.hashPassword('abc123') },
  ]);
