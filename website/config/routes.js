...
module.exports.routes = {
  ...
  'GET /docs/using-fleet/audit-activities': '/docs/api/global-audit-logs',
  ...
  'GET /docs/using-fleet/audit-logs': (req, res) => { return res.redirect(301, 'https://github.com/fleetdm/fleet/blob/main/docs/api/global-audit-logs.md'); },
