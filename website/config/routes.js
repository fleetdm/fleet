...
module.exports.routes = {
  ...
  'GET /docs/using-fleet/mdm-setup': (req,res)=> { return res.redirect(301, '/guides/mdm-setup');},
  'GET /docs/using-fleet/mdm-migration-guide': (req,res)=> { return res.redirect(301, '/guides/mdm-migration-guide');},
  'GET /docs/using-fleet/mdm-os-updates': (req,res)=> { return res.redirect(301, '/guides/mdm-os-updates');},
  'GET /docs/using-fleet/mdm-disk-encryption': (req,res)=> { return res.redirect(301, '/guides/mdm-disk-encryption');},
  'GET /docs/using-fleet/mdm-custom-os-settings': (req,res)=> { return res.redirect(301, '/guides/mdm-custom-os-settings');},
  'GET /docs/using-fleet/mdm-macos-setup-experience': (req,res)=> { return res.redirect(301, '/guides/mdm-macos-setup-experience');},
  ...
  'GET /docs/using-fleet/osquery-process': (req,res)=> { return res.redirect(301, '/guides/osquery-process');},
  'GET /docs/using-fleet/update-agents': (req,res)=> { return res.redirect(301, '/guides/fleet-agent-updates');},
  ...
  'GET /docs/using-fleet/audit-logs': (req,res)=> { return res.redirect(301, 'https://github.com/fleetdm/fleet/blob/main/docs/Contributing/Audit-logs');},
  'GET /docs/using-fleet/understanding-host-vitals': (req,res)=> { return res.redirect(301, 'https://github.com/fleetdm/fleet/blob/main/docs/Contributing/Understanding-host-vitals');},
