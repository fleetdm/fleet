...
module.exports = {
  ...
  attributes: {
    ...
    organization: {
      type: 'string',
      required: false, // Changing this attribute to `required: false`
...
without necessarily having a billing card.`
    ...
    fleetSandboxDemoKey: {
      type: 'string',
      description: 'The short-lived demo key generated by this user\'s Fleet Sandbox instance, used to authenticate this user automatically when redirecting them to their instance.',
      example: 'a83bba919ha139135913',
    },
