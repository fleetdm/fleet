module.exports = {
  ...
  fn: async function () {
    ...
    // Check if the user has a fleetSandboxURL (this.req.me.fleetSandboxUrl)
      // If the user doesn't have a fleetSandboxURL, they will be taken to the sandbox page with an empty fleetSandboxURL
    ...
    // Check the fleetSandboxExpiresAt (this.req.me.fleetSandboxExpiresAt)
      ...
      // If the sandbox instance is expired, we'll skip checking it's `/healthz` endpoint and continue to the sandbox page
