  ...
  fn: async function ({botSignature, action, sender, repository, changes, issue, comment, pull_request: pr, label, projects_v2_item: projectsV2Item}) {
    ...
    if (
      ...
      if (action === 'edited' && pr.state !== 'open') {// PR edited ‡
        ...
        let CHANGED_PATHS_THAT_CREATE_ANALYTICS_ANNOTATIONS = [ 'website/views/pages/homepage.ejs', 'website/views/pages/pricing.ejs', 'website/views/partials/primary-tagline.partial.ejs', 'website/views/contact.ejs'];
