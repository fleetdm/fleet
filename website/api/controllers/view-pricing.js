module.exports = {
  ...
  fn: async function () {
    ...
    let pricingTableCategories = ['Deployment', 'Configuration', 'Management', 'Security & compliance', 'Integrations', 'Support'];
    ...
    let categoryOrderForSecurityPricingTable = ['Deployment', 'Configuration', 'Management', 'Security & compliance', 'Integrations', 'Support'];
    ...
    let categoryOrderForITPricingTable = ['Deployment', 'Configuration', 'Management', 'Security & compliance', 'Integrations', 'Support'];
