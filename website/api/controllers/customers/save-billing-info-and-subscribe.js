module.exports = {
  ...
  fn: async function (inputs) {
    ...
    .tolerate(['non200Response', 'requestFailed'], (err)=>{
      ...
      sails.log.warn(`When a user purchased a Fleet Premium license, a lead/contact could not be updated in the CRM for this email address: ${newEmailAddress}. Raw error: ${err}`);
      return;
    });
