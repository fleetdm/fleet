module.exports = {
  ...
  friendlyName: 'View basic whitepaper (ungated)',


  description: 'Display an ungated whitepaper page with a direct download link instead of a lead-capture form.',
  ...
  exits: {
    ...
    success: {
      viewTemplatePath: 'pages/articles/basic-whitepaper-ungated'
    },
