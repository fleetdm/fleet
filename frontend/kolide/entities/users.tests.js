...
describe('Kolide - API client (users)', () => {
  ...
  describe('#changePassword', () => {
    it('calls the appropriate endpoint with the correct parameters', () => {
      ...
      const request = userMocks.changePassword.valid(bearerToken, passwordParams);

      Kolide.setBearerToken(bearerToken);
      return Kolide.users.changePassword(passwordParams)
        .then(() => {
  ...
  describe('#confirmEmailChange', () => {
    it('calls the appropriate endpoint with the correct parameters', () => {
      ...
      Kolide.setBearerToken(bearerToken);
      return Kolide.users.confirmEmailChange(userStub, token)
        .then(() => {
          expect(request.isDone()).toEqual(true);
        });
    });
  ...
  describe('#enable', () => {
    it('calls the appropriate endpoint with the correct parameters', () => {
      ...
      const request = userMocks.enable.valid(bearerToken, userStub, enableParams);

      Kolide.setBearerToken(bearerToken);
      return Kolide.users.enable(userStub, enableParams)
        .then(() => {
          expect(request.isDone()).toEqual(true);
        });
    });
  ...
  describe('#resetPassword', () => {
    ...
    it('return errors correctly for unsuccessful requests', () => {
      ...
      const request = userMocks.resetPassword.invalid(newPassword, passwordResetToken, errorResponse);
      const formData = {
        new_password: newPassword,
        password_reset_token: passwordResetToken,
      };
  ...
  describe('#update', () => {
    it('calls the appropriate endpoint with the correct parameters', () => {
      ...
      return Kolide.users.update(userStub, formData)
        .then(() => {
          expect(request.isDone()).toEqual(true);
        });
    });
  ...
  describe('#updateAdmin', () => {
    it('calls the appropriate endpoint with the correct parameters', () => {
      ...
      const request = userMocks.updateAdmin.valid(bearerToken, userStub, adminParams);

      Kolide.setBearerToken(bearerToken);
      return Kolide.users.updateAdmin(userStub, adminParams)
        .then(() => {
          expect(request.isDone()).toEqual(true);
        });
    });
