...
describe('Kolide - API client (queries)', () => {
  ...
  describe('#create', () => {
    it('calls the correct endpoint with the correct parameters', () => {
      ...
      return Kolide.queries.create(queryParams)
        .then((queryResponse) => {
  ...
  describe('#destroy', () => {
    it('calls the correct endpoint with the correct parameters', () => {
      ...
      Kolide.setBearerToken(bearerToken);
      return Kolide.queries.destroy(queryStub)
        .then(() => {
          expect(request.isDone()).toEqual(true);
        });
    });
  ...
  describe('#load', () => {
    it('calls the correct endpoint with the correct parameters', () => {
      ...
      Kolide.setBearerToken(bearerToken);
      return Kolide.queries.load(queryID)
        .then(() => {
          expect(request.isDone()).toEqual(true);
        });
    });
  ...
  describe('#run', () => {
    it('calls the correct endpoint with the correct params', () => {
      ...
      Kolide.setBearerToken(bearerToken);
      return Kolide.queries.run(data)
        .then(() => {
          expect(request.isDone()).toEqual(true);
        });
    });
  ...
  describe('#update', () => {
    it('calls the correct endpoint with the correct params', () => {
      ...
      const request = queryMocks.update.valid(bearerToken, query, updateQueryParams);

      Kolide.setBearerToken(bearerToken);
      return Kolide.queries.update(query, updateQueryParams)
        .then((queryResponse) => {
          expect(request.isDone()).toEqual(true);
