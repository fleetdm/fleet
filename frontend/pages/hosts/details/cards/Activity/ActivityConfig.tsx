...
> = {
  ...
  [ActivityType.TriggeredHostRecoveryLockPasswordRotation]: RotatedHostRecoveryLockPasswordActivityItem,
  [ActivityType.AutoRotatedHostRecoveryLockPassword]: RotatedHostRecoveryLockPasswordActivityItem,
