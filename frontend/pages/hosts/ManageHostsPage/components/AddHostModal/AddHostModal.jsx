...
class AddHostModal extends Component {
  ...
  constructor(props) {
    ...
    this.userRole = {
      isAtLeastAnyTeamMaintainer: permissionUtils.isAtLeastAnyTeamMaintainer(
    ...
    this.currentUserTeams = this.userRole.isAtLeastAnyTeamMaintainer
  ...
  createTeamDropdownOptions = (currentUserTeams = []) => {
    ...
    return this.userRole.isAtLeastAnyTeamMaintainer
      ? teamOptions
