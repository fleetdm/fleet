...
describe('Breadcrumbs - component', () => {
  ...
  it('renders page 1 Button as active when the page prop is 1', () => {
    ...
    expect(page1Btn.prop('className')).toContain('registration-breadcrumbs__page--active');
    expect(page2Btn.prop('className')).not.toContain('registration-breadcrumbs__page--active');
    expect(page3Btn.prop('className')).not.toContain('registration-breadcrumbs__page--active');
  });
