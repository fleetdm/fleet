...
that are based on fleets (if any) and device platforms (macOS, Linux, Windows). 
...
fleet and platform selected. Cards are applied in a delcarative form, as functions, rather than
