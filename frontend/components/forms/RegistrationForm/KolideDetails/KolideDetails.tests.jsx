...
describe('KolideDetails - form', () => {
  describe('kolide web address input', () => {
    ...
    it('updates state when the field changes', () => {
      ...
      expect(form.state().formData).toMatchObject({ kolide_server_url: 'https://gnar.kolide.co' });
    });
  });
  ...
  describe('submitting the form', () => {
    it('validates the presence of the kolide web address field', () => {
      ...
      expect(form.state().errors).toMatchObject({ kolide_server_url: 'Kolide web address must be completed' });
    });
