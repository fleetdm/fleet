import { IHostPolicy, IPolicyStats } from "interfaces/policy";

export const JACOB_FAKE_POLICIES: IHostPolicy[] = [
  {
    id: 5,
  ...
  {
    id: 29090,
    name: "Windows machines with encrypted hard disks 2",
    query: "SELECT 1 FROM bitlocker_info WHERE protection_status = 1;",
    description: "Checks if the hard disk is encrypted on Windows devices",
    critical: false,
    author_id: 43,
  ...
  {
    id: 136,
    name: "Arbitrary Test Policy (all platforms) (all teams) 2",
    query: "SELECT 1 FROM osquery_info WHERE 1=1;",
    description:
      "If you're seeing this, mostly likely this is because someone is testing out failing policies in dogfood. You can ignore this.",
    critical: true,
