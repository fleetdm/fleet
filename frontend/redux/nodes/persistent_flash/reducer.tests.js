...
describe('persistent_flash - reducer', () => {
  ...
  it(
    'shows the flash and sets the message when showPersistentFlash is dispatched',
    () => {
  ...
  it(
    'hides the flash and removes the message when hidePersistentFlash is dispatched',
    () => {
