...
func FleetFlags(fleetURL *url.URL) []string {
	...
	return []string{
		...
		"--enroll_tls_endpoint=" + path.Join(prefix, "/api/latest/osquery/enroll"),
		"--config_plugin=tls",
		"--config_tls_endpoint=" + path.Join(prefix, "/api/latest/osquery/config"),
		...
		"--distributed_tls_read_endpoint=" + path.Join(prefix, "/api/latest/osquery/distributed/read"),
		"--distributed_tls_write_endpoint=" + path.Join(prefix, "/api/latest/osquery/distributed/write"),
		"--logger_plugin=tls,filesystem",
		"--logger_tls_endpoint=" + path.Join(prefix, "/api/latest/osquery/log"),
		...
		"--carver_start_endpoint=" + path.Join(prefix, "/api/latest/osquery/carve/begin"),
		"--carver_continue_endpoint=" + path.Join(prefix, "/api/latest/osquery/carve/block"),
