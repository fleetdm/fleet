...
func (c *Client) LiveQueryWithContext(
	...
	req := fleet.CreateDistributedQueryCampaignByIdentifierRequest{
		QueryID:  queryID,
		QuerySQL: query,
		Selected: fleet.DistributedQueryCampaignTargetsByIdentifiers{Labels: labels, Hosts: hostIdentifiers},
	}
	verb, path := "POST", "/api/latest/fleet/queries/run_by_identifiers"
	var responseBody fleet.CreateDistributedQueryCampaignResponse
