...
var (
	...
	ErrMissingLicense        = errors.New("Requires Fleet Premium license")
...
// ExtractServerErrorText is the exported version of extractServerErrorText,
// for use by packages outside the client package.
func ExtractServerErrorText(body io.Reader) string {
	return extractServerErrorText(body)
}

// ExtractServerErrorNameReason is the exported version of extractServerErrorNameReason,
// for use by packages outside the client package.
func ExtractServerErrorNameReason(body io.Reader) (string, string) {
	return extractServerErrorNameReason(body)
}

// ExtractServerErrorNameReasons is the exported version of extractServerErrorNameReasons,
// for use by packages outside the client package.
func ExtractServerErrorNameReasons(body io.Reader) ([]string, []string) {
	return extractServerErrorNameReasons(body)
}
