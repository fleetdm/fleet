...
func (c *Client) CreateUser(p fleet.UserPayload) (*string, error) {
	...
	var responseBody fleet.CreateUserResponse
...
func (c *Client) ListUsers() ([]fleet.User, error) {
	...
	var responseBody fleet.ListUsersResponse
...
func (c *Client) ApplyUsersRoleSecretSpec(spec *fleet.UsersRoleSpec) error {
	req := fleet.ApplyUserRoleSpecsRequest{Spec: spec}
	verb, path := "POST", "/api/latest/fleet/users/roles/spec"
	var responseBody fleet.ApplyUserRoleSpecsResponse
...
func (c *Client) DeleteUser(email string) error {
	...
	var responseBody fleet.DeleteUserResponse
...
func (c *Client) Me() (*fleet.User, error) {
	...
	var responseBody fleet.GetUserResponse
	err := c.authenticatedRequest(nil, verb, path, &responseBody)
