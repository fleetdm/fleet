...
data "aws_iam_role" "sandbox_sso" {
  name = local.account_role_mapping[data.aws_caller_identity.current.account_id]
}
...
module "aws-eks-accelerator-for-terraform" {
  ...
  map_roles = [for i in concat(var.eks_allowed_roles, [data.aws_iam_role.admin, data.aws_iam_role.sandbox_sso]) : {
    rolearn  = i.arn
    username = i.id
