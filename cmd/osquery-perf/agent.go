...
func (s *Stats) Log() {
	...
	fmt.Printf(
		"%s v.1.0.0 :: error rate: %.2f, osquery enrolls: %d, orbit enrolls: %d, mdm enrolls: %d, distributed/writes: %d, mdm commands received: %d, orbit errors: %d, desktop errors: %d, mdm errors: %d\n",
