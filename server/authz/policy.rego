...
# Global admins, maintainers, gitops, observer_plus and observers can read scripts.
allow {
  object.type == "script"
...
# Team admins, maintainers, gitops, observer_plus and observers can read scripts for their teams.
allow {
  object.type == "script"
  not is_null(object.team_id)
  team_role(subject, object.team_id) == [admin, maintainer, gitops, observer_plus, observer][_]
