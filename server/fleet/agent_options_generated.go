// Automatically generated by tools/osquery-agent-options for osquery 5.21.0. DO NOT EDIT!
...
type osqueryOptions struct { 
	...
	DnsResolverRefreshInterval int32 `json:"dns_resolver_refresh_interval"`
...
type osqueryCommandLineFlags struct { 
	...
	ThriftTimeout uint32 `json:"thrift_timeout"`
	ThriftVerbose bool `json:"thrift_verbose"`
	TlsAcceptGzip bool `json:"tls_accept_gzip"`
