...
type OrbitConfigNotifications struct {
	...
	// RunSetupExperienceInstalls indicates whether or not there are steps to execute on the host as part
	// of Setup Experience on macOS.
	RunSetupExperienceInstalls bool `json:"run_setup_experience_installs,omitempty"`
}
