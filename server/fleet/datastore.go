...
type Datastore interface {
	...
	// FeatureMigrationStatus returns nil if feature migrations are complete, and an error if migrations need to be run.
	FeatureMigrationStatus(ctx context.Context) (*MigrationStatus, error)
