...
type Datastore interface {
	...
	// user. Only SCIM-provisioned UPNs are mapped; an unknown or empty UPN removes
	// a previous Entra join mapping. Manual ("idp") and authenticated
	// ("mdm_idp_accounts") mappings win and make this a no-op. Returns true when
	// the mapping was created, changed or removed.
