...
type Datastore interface {
	...
	// GetInHouseAppMetadataByTeamAndTitleID returns the in house app corresponding
	// to the specific team and title ids.
	...
	InsertInHouseApp(ctx context.Context, payload *InHouseAppPayload) (installerID uint, titleID uint, err error)
}
