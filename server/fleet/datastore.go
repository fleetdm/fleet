...
type Datastore interface {
	...
	// device id, which happens because the HW device id is cached in the OS enrollment state and machines cloned from an
	// already-enrolled image all present the image's value.
