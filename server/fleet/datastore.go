...
type Datastore interface {
	...
	// MDMWindowsSaveResponse saves command results for the given enrollment.
	// When saveFullResponse is true, the full SyncML envelope is also stored
	// in windows_mdm_responses for debugging purposes.
	MDMWindowsSaveResponse(ctx context.Context, enrolledDevice *MDMWindowsEnrolledDevice, enrichedSyncML EnrichedSyncML, commandIDsBeingResent []string, saveFullResponse bool) (*MDMWindowsSaveResponseResult, error)
