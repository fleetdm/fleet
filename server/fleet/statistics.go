...
type StatisticsPayload struct {
	...
	NumTeams                       int    `json:"numTeams"` //nolint:apiparamcheck
	NumPolicies                    int    `json:"numPolicies"`
	NumQueries                     int    `json:"numQueries"` //nolint:apiparamcheck
	...
	LiveQueryDisabled              bool   `json:"liveQueryDisabled"` //nolint:apiparamcheck // osquery live-query feature (SQL-sense)
