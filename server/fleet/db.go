...
type DBLock struct {
	...
	WaitingQuery   *string `db:"waiting_query" json:"waiting_query,omitempty"` //nolint:apiparamcheck // MySQL InnoDB lock query text (SQL-sense)
	...
	BlockingQuery  *string `db:"blocking_query" json:"blocking_query,omitempty"` //nolint:apiparamcheck // MySQL InnoDB lock query text (SQL-sense)
}
