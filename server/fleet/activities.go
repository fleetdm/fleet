...
type ActivityTypeCreatedPolicy struct {
	...
	TeamID   *int64  `json:"fleet_id,omitempty" renamedfrom:"team_id"`
...
type ActivityTypeCreatedTeam struct {
	...
	Name string `json:"fleet_name" renamedfrom:"team_name"`
}
...
type ActivityTypeAppliedSpecTeam struct {
	Teams []TeamActivityDetail `json:"fleets" renamedfrom:"teams"`
}
...
type ActivityTypeTransferredHostsToTeam struct {
	...
	TeamName         *string  `json:"fleet_name" renamedfrom:"team_name"`
