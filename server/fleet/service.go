...
type Service interface {
	...
	// AuthenticateDeviceByURL loads host identified by the URL UUID.
	...
	AuthenticateDeviceByURL(ctx context.Context, urlUUID string) (host *Host, debug bool, err error)
