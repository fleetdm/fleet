...
type MDM struct {
	// ServerURL is an alternate URL to be used in MDM configuration profiles to differentiate MDM
	// requests from fleetd requests on customer networks.  ServerURL DNS should resolve to the
