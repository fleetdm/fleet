...
type Host struct {
	...
	// GigsTotalDiskSpace and GigsAllDiskSpace both represent UNUSED disk space (not total disk space
	// - the names are misguiding) as defined by `server > service > osquery_utils >
