...
type Host struct {
	...
	TeamID                    *uint               `json:"fleet_id,renamed" db:"team_id" csv:"team_id"`
	...
	TeamName *string `json:"fleet_name,renamed" db:"team_name" csv:"team_name"`
...
type HostSummary struct {
	TeamID             *uint                  `json:"fleet_id,omitempty,renamed" db:"-"`
