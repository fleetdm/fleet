...
func (d *CarveStore) generateS3Key(metadata *fleet.CarveMetadata) string {
...
func (d *CarveStore) NewCarve(ctx context.Context, metadata *fleet.CarveMetadata) (*fleet.CarveMetadata, error) {
...
func (d *CarveStore) UpdateCarve(ctx context.Context, metadata *fleet.CarveMetadata) error {
...
func (d *CarveStore) listS3Carves(lastPrefix string, maxKeys int) (map[string]bool, error) {
	var err error
...
func (d *CarveStore) CleanupCarves(ctx context.Context, now time.Time) (int, error) {
	var err error
...
func (d *CarveStore) Carve(ctx context.Context, carveID int64) (*fleet.CarveMetadata, error) {
	return d.metadatadb.Carve(ctx, carveID)
}

// CarveBySessionId returns carve metadata by session ID
func (d *CarveStore) CarveBySessionId(ctx context.Context, sessionID string) (*fleet.CarveMetadata, error) {
	return d.metadatadb.CarveBySessionId(ctx, sessionID)
}

// CarveByName returns carve metadata by name
func (d *CarveStore) CarveByName(ctx context.Context, name string) (*fleet.CarveMetadata, error) {
	return d.metadatadb.CarveByName(ctx, name)
}

// ListCarves returns a list of the currently available carves
func (d *CarveStore) ListCarves(ctx context.Context, opt fleet.CarveListOptions) ([]*fleet.CarveMetadata, error) {
...
func (d *CarveStore) listCompletedParts(objectKey, uploadID string) ([]*s3.CompletedPart, error) {
...
func (d *CarveStore) NewBlock(ctx context.Context, metadata *fleet.CarveMetadata, blockID int64, data []byte) error {
	objectKey := d.generateS3Key(metadata)
...
func (d *CarveStore) GetBlock(ctx context.Context, metadata *fleet.CarveMetadata, blockID int64) ([]byte, error) {
	objectKey := d.generateS3Key(metadata)
