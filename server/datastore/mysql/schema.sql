...
CREATE TABLE `host_script_results` (
  ...
  KEY `idx_host_script_results_host_policy_attempt` (`host_id`,`policy_id`,`attempt_number`),
...
CREATE TABLE `host_software_installed_paths` (
  ...
  `binary_sha256` char(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `host_software_installs` (
  ...
  KEY `idx_host_software_installs_host_policy_attempt` (`host_id`,`policy_id`,`attempt_number`),
