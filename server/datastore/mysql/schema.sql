...
CREATE TABLE `host_recovery_key_passwords` (
  ...
  `pending_encrypted_password` blob,
  `auto_rotate_at` timestamp(6) NULL DEFAULT NULL,
  `pending_set_command_uuid` varchar(127) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `pending_verify_command_uuid` varchar(127) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
