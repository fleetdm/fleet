...
CREATE TABLE `queries` (
  ...
  `platform` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `min_osquery_version` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `schedule_interval` int(10) unsigned DEFAULT '0',
  `automations_enabled` tinyint(1) unsigned DEFAULT '0',
  `logging_type` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT 'snapshot',
  PRIMARY KEY (`id`),
