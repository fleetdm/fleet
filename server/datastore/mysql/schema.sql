...
CREATE TABLE `batch_activity_host_results` (
  ...
  KEY `idx_bahr_host_execution_id` (`host_execution_id`),
...
CREATE TABLE `host_script_results` (
  ...
  KEY `idx_host_script_results_created_at` (`created_at`),
