...
/*!40101 SET character_set_client = @saved_cs_client */;
INSERT INTO `labels` VALUES (1,'2024-04-03 00:00:00','2025-10-09 13:23:10','macOS 14+ (Sonoma+)','macOS hosts with version 14 and above','select 1 from os_version where platform = \'darwin\' and major >= 14;','',1,0,NULL,NULL),(2,'2024-06-28 00:00:00','2025-10-09 13:23:10','iOS','All iOS hosts','','',1,1,NULL,NULL),(3,'2024-06-28 00:00:00','2025-10-09 13:23:10','iPadOS','All iPadOS hosts','','',1,1,NULL,NULL),(4,'2024-09-27 00:00:00','2025-10-09 13:23:10','Fedora Linux','All Fedora hosts','select 1 from os_version where name = \'Fedora Linux\';','',1,0,NULL,NULL),(5,'2025-02-25 00:00:00','2025-10-09 13:23:10','Android','All Android hosts','','',1,1,NULL,NULL);
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
