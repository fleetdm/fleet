...
CREATE TABLE `certificate_authorities` (
  ...
  `type` enum('digicert','ndes_scep_proxy','custom_scep_proxy','hydrant','smallstep','custom_est_proxy','okta') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `host_mdm_managed_certificates` (
  ...
  `type` enum('digicert','custom_scep_proxy','ndes','smallstep','okta') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ndes',
