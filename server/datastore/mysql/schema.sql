...
CREATE TABLE `hosts` (
  ...
  `sort_seen_time` timestamp NULL DEFAULT NULL,
  `sort_software_updated_at` timestamp NULL DEFAULT NULL,
  `sort_gigs_disk_space_available` decimal(10,2) NOT NULL DEFAULT '0.00',
  `sort_gigs_total_disk_space` decimal(10,2) NOT NULL DEFAULT '0.00',
  `sort_percent_disk_space_available` decimal(10,2) NOT NULL DEFAULT '0.00',
  `sort_total_issues_count` int unsigned NOT NULL DEFAULT '0',
  `sort_team_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `idx_hosts_sort_seen_time` (`sort_seen_time`),
  KEY `idx_hosts_sort_software_updated_at` (`sort_software_updated_at`),
  KEY `idx_hosts_sort_gigs_disk_space_available` (`sort_gigs_disk_space_available`),
  KEY `idx_hosts_sort_gigs_total_disk_space` (`sort_gigs_total_disk_space`),
  KEY `idx_hosts_sort_percent_disk_space_available` (`sort_percent_disk_space_available`),
  KEY `idx_hosts_sort_total_issues_count` (`sort_total_issues_count`),
  KEY `idx_hosts_sort_team_name` (`sort_team_name`),
