...
CREATE TABLE `activities` (
  ...
  CONSTRAINT `activities_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users_all` (`id`) ON DELETE SET NULL
...
CREATE TABLE `email_changes` (
  ...
  CONSTRAINT `fk_email_changes_users` FOREIGN KEY (`user_id`) REFERENCES `users_all` (`id`) ON DELETE CASCADE
) /*!50100 TABLESPACE `innodb_system` */ ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
CREATE TABLE `host_certificates` (
  ...
  `subject_country` varchar(2) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  `issuer_country` varchar(2) COLLATE utf8mb4_unicode_ci NOT NULL,
...
CREATE TABLE `host_script_results` (
  ...
  CONSTRAINT `fk_host_script_results_user_id` FOREIGN KEY (`user_id`) REFERENCES `users_all` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `host_software_installs` (
  ...
  CONSTRAINT `fk_host_software_installs_user_id` FOREIGN KEY (`user_id`) REFERENCES `users_all` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `host_vpp_software_installs` (
  ...
  CONSTRAINT `host_vpp_software_installs_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users_all` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `labels` (
  ...
  CONSTRAINT `labels_ibfk_1` FOREIGN KEY (`author_id`) REFERENCES `users_all` (`id`) ON DELETE SET NULL
...
CREATE TABLE `policies` (
  ...
  CONSTRAINT `policies_queries_ibfk_1` FOREIGN KEY (`author_id`) REFERENCES `users_all` (`id`) ON DELETE SET NULL
) /*!50100 TABLESPACE `innodb_system` */ ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
CREATE TABLE `queries` (
  ...
  CONSTRAINT `queries_ibfk_1` FOREIGN KEY (`author_id`) REFERENCES `users_all` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `software_installers` (
  ...
  CONSTRAINT `fk_software_installers_user_id` FOREIGN KEY (`user_id`) REFERENCES `users_all` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `software_titles` (
  ...
  `unique_identifier` varchar(255) COLLATE utf8mb4_unicode_ci GENERATED ALWAYS AS (coalesce(`bundle_identifier`,`name`)) VIRTUAL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `upcoming_activities` (
  ...
  CONSTRAINT `fk_upcoming_activities_user_id` FOREIGN KEY (`user_id`) REFERENCES `users_all` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `user_teams` (
  ...
  CONSTRAINT `user_teams_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users_all` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
/*!50001 CREATE VIEW `users` AS SELECT 
 ...
 1 AS `name`,
 1 AS `email`,
 1 AS `admin_forced_password_reset`,
 1 AS `gravatar_url`,
 1 AS `position`,
 1 AS `sso_enabled`,
 1 AS `global_role`,
...
CREATE TABLE `verification_tokens` (
  ...
  CONSTRAINT `verification_tokens_users` FOREIGN KEY (`user_id`) REFERENCES `users_all` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`%` SQL SECURITY DEFINER */
/*!50001 VIEW `users` AS select `users_all`.`id` AS `id`,`users_all`.`created_at` AS `created_at`,`users_all`.`updated_at` AS `updated_at`,`users_all`.`password` AS `password`,`users_all`.`salt` AS `salt`,`users_all`.`name` AS `name`,`users_all`.`email` AS `email`,`users_all`.`admin_forced_password_reset` AS `admin_forced_password_reset`,`users_all`.`gravatar_url` AS `gravatar_url`,`users_all`.`position` AS `position`,`users_all`.`sso_enabled` AS `sso_enabled`,`users_all`.`global_role` AS `global_role`,`users_all`.`api_only` AS `api_only`,`users_all`.`mfa_enabled` AS `mfa_enabled`,`users_all`.`settings` AS `settings`,`users_all`.`deleted_at` AS `deleted_at`,`users_all`.`deleted_by_user_id` AS `deleted_by_user_id` from `users_all` where (`users_all`.`deleted_at` is null) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
