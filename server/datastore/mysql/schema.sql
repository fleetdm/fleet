...
CREATE TABLE `policies` (
  ...
  `fleet_managed_key` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `fleet_managed_team_key` varchar(96) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci GENERATED ALWAYS AS (if((`fleet_managed_key` is null),NULL,concat_ws(_utf8mb4':',if((`team_id` is null),_utf8mb4'global',cast(`team_id` as char charset utf8mb4)),`fleet_managed_key`))) STORED,
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_policies_checksum` (`checksum`),
  UNIQUE KEY `idx_team_id_patch_software_title_id` (`team_id`,`patch_software_title_id`),
  UNIQUE KEY `idx_policies_fleet_managed_team_key` (`fleet_managed_team_key`),
  ...
  KEY `idx_policies_fleet_managed_key` (`fleet_managed_key`),
