...
CREATE TABLE `abm_tokens` (
  ...
  `tvos_default_team_id` int unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `fk_abm_tokens_tvos_default_team_id` (`tvos_default_team_id`),
  ...
  CONSTRAINT `fk_abm_tokens_tvos_default_team_id` FOREIGN KEY (`tvos_default_team_id`) REFERENCES `teams` (`id`) ON DELETE SET NULL,
...
/*!40101 SET character_set_client = @saved_cs_client */;
INSERT INTO `labels` VALUES (1,'2024-04-03 00:00:00','2025-10-09 00:00:00','macOS 14+ (Sonoma+)','macOS hosts with version 14 and above','select 1 from os_version where platform = \'darwin\' and major >= 14;','',1,0,NULL,NULL,NULL),(2,'2024-06-28 00:00:00','2025-10-09 00:00:00','iOS','All iOS hosts','','',1,1,NULL,NULL,NULL),(3,'2024-06-28 00:00:00','2025-10-09 00:00:00','iPadOS','All iPadOS hosts','','',1,1,NULL,NULL,NULL),(4,'2024-09-27 00:00:00','2025-10-09 00:00:00','Fedora Linux','All Fedora hosts','select 1 from os_version where name = \'Fedora Linux\';','',1,0,NULL,NULL,NULL),(5,'2025-02-25 00:00:00','2025-10-09 00:00:00','Android','All Android hosts','','',1,1,NULL,NULL,NULL),(6,'2026-08-11 00:00:00','2026-08-11 00:00:00','tvOS','All tvOS hosts','','',1,1,NULL,NULL,NULL);
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
CREATE TABLE `software_titles` (
  ...
  `additional_identifier` tinyint unsigned GENERATED ALWAYS AS ((case when (`source` = _utf8mb4'ios_apps') then 1 when (`source` = _utf8mb4'ipados_apps') then 2 when (`source` = _utf8mb4'tvos_apps') then 3 when (`bundle_identifier` is not null) then 0 else NULL end)) VIRTUAL,
