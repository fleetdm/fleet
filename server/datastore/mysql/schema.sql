...
CREATE TABLE `host_lifecycle_events` (
  ...
  `host_id` int unsigned NOT NULL,
  `event_type` enum('started_mdm_setup','completed_mdm_setup','started_mdm_migration','completed_mdm_migration') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
  `activity_id` int unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `idx_host_lifecycle_events_host_id` (`host_id`),
  KEY `idx_host_lifecycle_events_host_uuid` (`host_uuid`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
