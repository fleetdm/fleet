...
CREATE TABLE `host_vpp_software_installs` (
  ...
  `policy_id` int unsigned DEFAULT NULL,
  `uninstall` tinyint NOT NULL DEFAULT '0',
  `canceled` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
