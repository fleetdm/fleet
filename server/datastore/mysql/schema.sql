...
CREATE TABLE `policies` (
  ...
  `team_id_x` int(10) unsigned GENERATED ALWAYS AS (coalesce(`team_id`,0)) VIRTUAL NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_policies_unique_name` (`name`,`team_id_x`),
