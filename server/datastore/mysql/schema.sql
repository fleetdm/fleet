...
CREATE TABLE `scim_users` (
  ...
  `fleet_user_id` int unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_scim_users_user_name` (`user_name`),
  KEY `idx_scim_users_external_id` (`external_id`),
  KEY `fk_scim_users_fleet_user_id` (`fleet_user_id`),
  CONSTRAINT `fk_scim_users_fleet_user_id` FOREIGN KEY (`fleet_user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL
) /*!50100 TABLESPACE `innodb_system` */ ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
