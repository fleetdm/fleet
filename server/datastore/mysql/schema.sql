...
CREATE TABLE `host_vpp_software_installs` (
  ...
  KEY `idx_host_vpp_software_installs_verification_at` (`verification_at`),
  KEY `idx_host_vpp_software_installs_verification_failed_at` (`verification_failed_at`),
