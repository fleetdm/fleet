...
CREATE TABLE `certificate_authorities` (
  ...
  `type` enum('digicert','ndes_scep_proxy','custom_scep_proxy','hydrant') COLLATE utf8mb4_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `url` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `api_token` blob,
  `profile_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `certificate_common_name` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `certificate_user_principal_names` json DEFAULT NULL,
  `certificate_seat_id` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
