...
CREATE TABLE `mdm_windows_enrollments` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `idx_mdm_windows_enrollments_hardware_id_host_uuid` (`mdm_hardware_id`,`host_uuid`),
