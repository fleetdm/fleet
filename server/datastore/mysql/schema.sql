...
CREATE TABLE `microsoft_compliance_partner_host_statuses` (
  `host_id` int unsigned NOT NULL,
  `device_id` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci DEFAULT '',
