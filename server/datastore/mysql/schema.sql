...
CREATE TABLE `policies` (
  ...
  `failed_policy_counts` mediumint(8) unsigned DEFAULT '0',
  `succeeded_policy_counts` mediumint(8) unsigned DEFAULT '0',
  PRIMARY KEY (`id`),
