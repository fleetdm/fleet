...
CREATE TABLE `host_mdm_apple_profiles` (
  ...
  CONSTRAINT `host_mdm_apple_profiles_ibfk_2` FOREIGN KEY (`status`) REFERENCES `mdm_apple_profile_status` (`status`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
/*!40101 SET character_set_client = @saved_cs_client */;
INSERT INTO `mdm_apple_profile_status` VALUES ('FAILED'),('INSTALLED'),('INSTALLING'),('REMOVING');
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
