...
CREATE TABLE `mdm_apple_configuration_profiles` (
  ...
  `checksum` binary(16) NOT NULL,
  `profile_uuid` varchar(37) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
  `user_persistent_info_id` int(10) unsigned DEFAULT NULL,
  ...
  KEY `fk_mdm_apple_configuration_profiles_user_info` (`user_persistent_info_id`),
  CONSTRAINT `fk_mdm_apple_configuration_profiles_user_info` FOREIGN KEY (`user_persistent_info_id`) REFERENCES `user_persistent_info` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `mdm_windows_configuration_profiles` (
  ...
  KEY `fk_mdm_windows_configuration_profiles_user_info` (`user_persistent_info_id`),
  CONSTRAINT `fk_mdm_windows_configuration_profiles_user_info` FOREIGN KEY (`user_persistent_info_id`) REFERENCES `user_persistent_info` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `nano_commands` (
  ...
  KEY `fk_nano_commands_user_info` (`user_persistent_info_id`),
  CONSTRAINT `fk_nano_commands_user_info` FOREIGN KEY (`user_persistent_info_id`) REFERENCES `user_persistent_info` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `user_persistent_info` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `user_id` int(10) unsigned DEFAULT NULL,
  ...
  CONSTRAINT `user_persistent_info_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
...
CREATE TABLE `windows_mdm_commands` (
  ...
  CONSTRAINT `fk_windows_mdm_commands_user_info` FOREIGN KEY (`user_persistent_info_id`) REFERENCES `user_persistent_info` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
