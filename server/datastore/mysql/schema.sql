...
CREATE TABLE `users` (
  ...
  `retry_check_good` tinyint(1) NOT NULL DEFAULT '0',
  `retry_check_bad` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
