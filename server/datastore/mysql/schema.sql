...
CREATE TABLE `policies` (
  ...
  `type` enum('dynamic','patch','mdm') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'dynamic',
  `patch_software_title_id` int unsigned DEFAULT NULL,
  `needs_full_membership_cleanup` tinyint(1) NOT NULL DEFAULT '0',
  `mdm_check_definition` json DEFAULT NULL,
  PRIMARY KEY (`id`),
