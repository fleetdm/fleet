...
CREATE TABLE `host_disk_encryption_keys` (
  ...
  `encryption_type` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'passphrase',
