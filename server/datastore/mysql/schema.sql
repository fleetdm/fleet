...
CREATE TABLE `software_installers` (
  ...
  KEY `idx_software_installers_platform_title_id` (`global_or_team_id`,`platform`,`title_id`,`version`) USING BTREE,
