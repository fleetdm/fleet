...
CREATE TABLE `upcoming_activities` (
  ...
  `execution_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `batch_execution_id` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '0',
  ...
  KEY `idx_batch_execution_id` (`batch_execution_id`),
