...
CREATE TABLE `mdm_android_configuration_profiles` (
  ...
  `description` varchar(1023) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT '',
