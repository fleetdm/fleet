...
CREATE TABLE `host_script_results` (
  ...
  `policy_run_id` bigint unsigned DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `host_vpp_software_installs` (
  ...
  KEY `idx_host_vpp_software_installs_policy_run` (`policy_run_id`),
  KEY `idx_host_vpp_software_installs_verification` ((((`verification_at` is null) and (`verification_failed_at` is null)))),
  CONSTRAINT `fk_host_vpp_software_installs_policy_run` FOREIGN KEY (`policy_run_id`) REFERENCES `host_policy_runs` (`id`) ON DELETE SET NULL,
...
CREATE TABLE `vpp_app_upcoming_activities` (
  ...
  KEY `idx_vpp_app_upcoming_activities_policy_run` (`policy_run_id`),
  ...
  CONSTRAINT `fk_vpp_app_upcoming_activities_policy_run` FOREIGN KEY (`policy_run_id`) REFERENCES `host_policy_runs` (`id`) ON DELETE SET NULL,
