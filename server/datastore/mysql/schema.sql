...
CREATE TABLE `host_software_installs` (
  ...
  `canceled` tinyint(1) NOT NULL DEFAULT '0',
  `attempt_number` int DEFAULT NULL,
  `skip_app_open_check` tinyint(1) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
