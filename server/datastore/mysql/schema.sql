...
CREATE TABLE `host_dep_assignments` (
  `host_hardware_serial` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  ...
  PRIMARY KEY (`host_hardware_serial`),
