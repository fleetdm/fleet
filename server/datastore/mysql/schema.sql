...
CREATE TABLE `mdm_windows_enrollments` (
  ...
  `wns_channel_uri` varchar(2048) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `wns_channel_uri_status` int DEFAULT NULL,
  `wns_channel_uri_updated_at` datetime(6) DEFAULT NULL,
  PRIMARY KEY (`id`),
