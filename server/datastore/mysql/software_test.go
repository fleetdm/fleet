...
func testListHostSoftwareWithLabelScoping(t *testing.T, ds *Datastore) {
	...
	require.NoError(t, err)
	require.Len(t, software, 2)
	require.Equal(t, software[0].Name, softwareAlreadyInstalled.Name)
	require.Equal(t, software[0].InstalledVersions[0].Version, softwareAlreadyInstalled.Version)
	require.Equal(t, software[0].SoftwarePackage.Version, installer1.Version)
	require.Equal(t, software[1].Name, mutationResults.Inserted[0].Name)
	require.Nil(t, software[1].InstalledVersions)
	require.Equal(t, software[1].SoftwarePackage.Version, selfServiceinstaller.Version)
	...
	require.Equal(t, software[0].SoftwarePackage.Version, installer1.Version)
	require.Equal(t, software[1].Name, mutationResults.Inserted[0].Name)
	require.Equal(t, software[1].InstalledVersions[0].Version, mutationResults.Inserted[0].Version)
	require.Equal(t, software[1].SoftwarePackage.Version, selfServiceinstaller.Version)
