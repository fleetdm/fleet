...
func (ds *Datastore) GetHostArchivedDiskEncryptionKey(ctx context.Context, host *fleet.Host, archivedFallbackToSerial bool) (*fleet.HostArchivedDiskEncryptionKey, error) {
...
LIMIT 1`
	...
	if err == sql.ErrNoRows && host.HardwareSerial != "" && archivedFallbackToSerial {
