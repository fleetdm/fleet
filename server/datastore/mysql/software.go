...
func (ds *Datastore) LoadHostSoftware(ctx context.Context, host *fleet.Host, opts fleet.SoftwareListOptions, includeCVEScores bool) error {
	opts.HostID = &host.ID
	opts.IncludeCVEScores = includeCVEScores
