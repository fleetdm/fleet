...
func testMDMAppleGetAndUpdateABMToken(t *testing.T, ds *Datastore) {
	...
	require.Equal(t, fleet.ReservedNameNoTeam, tok.MacOSTeamName)
	require.Equal(t, fleet.ReservedNameNoTeam, tok.IOSTeamName)
	require.Equal(t, fleet.ReservedNameNoTeam, tok.IPadOSTeamName)
	...
	require.Equal(t, fleet.ReservedNameNoTeam, tokReload.IPadOSTeamName)
	require.Equal(t, fleet.ReservedNameNoTeam, tokReload.IPadOSTeam.Name)
	...
	require.Equal(t, "org-name", tokReload.OrganizationName)
	require.Equal(t, "name@example.com", tokReload.AppleID)
	require.Equal(t, fleet.ReservedNameNoTeam, tokReload.MacOSTeamName)
	require.Equal(t, fleet.ReservedNameNoTeam, tokReload.MacOSTeam.Name)
	...
	require.Equal(t, fleet.ReservedNameNoTeam, expTok.MacOSTeamName)
	require.Equal(t, fleet.ReservedNameNoTeam, expTok.MacOSTeam.Name)
