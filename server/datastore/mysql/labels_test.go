...
func testUpdateLabelMembershipByHostIDs(t *testing.T, ds *Datastore) {
	...
	_, hostIDs, err := ds.UpdateLabelMembershipByHostIDs(ctx, label1.ID, []uint{host1.ID, host2.ID}, filter)
	require.NoError(t, err)
	...
	_, _, err = ds.UpdateLabelMembershipByHostIDs(ctx, label1.ID, []uint{host1.ID, host3.ID}, filter)
	require.NoError(t, err)
	...
	_, _, err = ds.UpdateLabelMembershipByHostIDs(ctx, label1.ID, []uint{host2.ID, host3.ID}, filter)
	require.NoError(t, err)
	...
	_, _, err = ds.UpdateLabelMembershipByHostIDs(ctx, label1.ID, []uint{}, filter)
	require.NoError(t, err)
	...
	_, hostIDs, err = ds.UpdateLabelMembershipByHostIDs(ctx, label1.ID, []uint{host1.ID, host2.ID, host3.ID}, filter)
	require.NoError(t, err)
