...
func init() {
	tables.MigrationClient.AddMigration(Up_20210817112308, Down_20210817112308)
}

func Up_20210817112308(tx *sql.Tx) error {
	row := tx.QueryRow(
		`SELECT 
       			org_name,
				org_logo_url,
...
func Down_20210817112308(tx *sql.Tx) error {
	return nil
}
