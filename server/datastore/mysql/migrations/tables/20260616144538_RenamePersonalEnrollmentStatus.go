...
func init() {
	MigrationClient.AddMigration(Up_20260616144538, Down_20260616144538)
}

// Up_20260616144538 renames the enrollment_status VIRTUAL GENERATED column
...
func Up_20260616144538(tx *sql.Tx) error {
	if _, err := tx.Exec(`
...
func Down_20260616144538(tx *sql.Tx) error {
	return nil
}
