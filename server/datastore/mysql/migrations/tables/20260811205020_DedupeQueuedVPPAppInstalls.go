...
func init() {
	MigrationClient.AddMigration(Up_20260811205020, Down_20260811205020)
}

// Up_20260811205020 removes redundant App Store app installs that Fleet queued for itself, keeping
...
func Up_20260811205020(tx *sql.Tx) error {
...
func Down_20260811205020(tx *sql.Tx) error {
	return nil
}
