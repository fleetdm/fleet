...
func init() {
	MigrationClient.AddMigration(Up_20230628173022, Down_20230628173022)
}

func Up_20230628173022(tx *sql.Tx) error {
	_, err := tx.Exec(`
          CREATE TABLE mdm_windows_enrollments (
            id INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
			mdm_device_id VARCHAR(255) NOT NULL,
			mdm_hardware_id VARCHAR(255) NOT NULL,
			device_identity_cert VARCHAR(255) NOT NULL,
			device_type VARCHAR(255) NOT NULL,
			device_name VARCHAR(255) NOT NULL,
			enroll_type VARCHAR(255) NOT NULL,
			enroll_user_id VARCHAR(255) NULL,
...
func Down_20230628173022(tx *sql.Tx) error {
