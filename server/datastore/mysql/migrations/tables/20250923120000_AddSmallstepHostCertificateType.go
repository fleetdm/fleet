...
MODIFY COLUMN type ENUM('digicert','custom_scep_proxy','ndes','smallstep_scep_proxy') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ndes';	`)
	if err != nil {
...
MODIFY COLUMN type ENUM('digicert', 'ndes_scep_proxy', 'custom_scep_proxy', 'hydrant', 'smallstep_scep_proxy') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
-- Smallstep fields
