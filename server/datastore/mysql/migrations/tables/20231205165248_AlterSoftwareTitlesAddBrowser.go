...
func init() {
	MigrationClient.AddMigration(Up_20231205165248, Down_20231205165248)
}

func Up_20231205165248(tx *sql.Tx) error {
	...
	_, err = tx.Exec(`ALTER TABLE software_titles ADD COLUMN browser varchar(255) NOT NULL DEFAULT ''`)
	if err != nil {
...
func Down_20231205165248(tx *sql.Tx) error {
	return nil
}
