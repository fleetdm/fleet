	...
	cases := []struct {
		...
		},
		{
			...
			func(ds *mock.Store, d *Datastore) (*bool, func() error) {
				...
				return &ds.DeleteLabelFuncInvoked, func() error { return d.DeleteLabel(ctx, "l", fleet.TeamFilter{}) }
			},
		},
		{
			...
			func(ds *mock.Store, d *Datastore) (*bool, func() error) {
				...
				return &ds.SaveLabelFuncInvoked, func() error {
					_, _, err := d.SaveLabel(ctx, &fleet.Label{}, []uint{1, 2}, fleet.TeamFilter{})
					return err
				}
			},
		},
		{
			...
			func(ds *mock.Store, d *Datastore) (*bool, func() error) {
				...
				return &ds.UpdateLabelMembershipByHostIDsFuncInvoked, func() error {
					_, _, err := d.UpdateLabelMembershipByHostIDs(ctx, fleet.Label{}, []uint{1}, fleet.TeamFilter{})
					return err
				}
			},
		},
	...
	}{
		{
			...
			func(ds *mock.Store, d *Datastore) (*bool, func() error) {
				...
				return &ds.RecordLabelQueryExecutionsFuncInvoked, func() error {
					return d.RecordLabelQueryExecutions(ctx, &fleet.Host{ID: 11}, nil, time.Now(), false)
				}
			},
		},
		{
			...
			func(ds *mock.Store, d *Datastore) (*bool, func() error) {
				...
				return &ds.AsyncBatchInsertLabelMembershipFuncInvoked, func() error {
					return d.AsyncBatchInsertLabelMembership(ctx, [][2]uint{{1, 21}, {2, 21}, {1, 22}})
				}
			},
		},
		{
			...
			func(ds *mock.Store, d *Datastore) (*bool, func() error) {
				...
				return &ds.AsyncBatchDeleteLabelMembershipFuncInvoked, func() error {
					return d.AsyncBatchDeleteLabelMembership(ctx, [][2]uint{{5, 31}})
				}
			},
		},
		{
			...
			func(ds *mock.Store, d *Datastore) (*bool, func() error) {
				...
				return &ds.AddLabelsToHostFuncInvoked, func() error { return d.AddLabelsToHost(ctx, 41, []uint{1}) }
			},
		},
		{
			...
			func(ds *mock.Store, d *Datastore) (*bool, func() error) {
				...
				return &ds.RemoveLabelsFromHostFuncInvoked, func() error { return d.RemoveLabelsFromHost(ctx, 51, []uint{1}) }
			},
		},
		{
			...
			func(ds *mock.Store, d *Datastore) (*bool, func() error) {
				...
				return &ds.UpdateLabelMembershipByHostCriteriaFuncInvoked, func() error {
					_, _, err := d.UpdateLabelMembershipByHostCriteria(ctx, &fleet.Label{})
					return err
				}
			},
		},
