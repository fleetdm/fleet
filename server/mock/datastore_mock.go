...
type SaveLUKSDataFunc func(ctx context.Context, host *fleet.Host, encryptedBase64Passphrase string, encryptedBase64Salt string, keySlot uint, encryptionType string) (bool, error)
...
func (s *DataStore) SaveLUKSData(ctx context.Context, host *fleet.Host, encryptedBase64Passphrase string, encryptedBase64Salt string, keySlot uint, encryptionType string) (bool, error) {
	s.mu.Lock()
	s.SaveLUKSDataFuncInvoked = true
	s.mu.Unlock()
	return s.SaveLUKSDataFunc(ctx, host, encryptedBase64Passphrase, encryptedBase64Salt, keySlot, encryptionType)
}
