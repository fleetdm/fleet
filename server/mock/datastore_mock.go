...
type IngestMDMAppleDevicesFromDEPSyncFunc func(ctx context.Context, devices []godep.Device, abmTokenID uint) (int64, *uint, error)
...
type GetABMTokenOrgNamesForTeamFunc func(ctx context.Context, teamID *uint) ([]string, error)
...
type DataStore struct {
	...
	GetABMTokenOrgNamesForTeamFunc        GetABMTokenOrgNamesForTeamFunc
	GetABMTokenOrgNamesForTeamFuncInvoked bool
...
func (s *DataStore) IngestMDMAppleDevicesFromDEPSync(ctx context.Context, devices []godep.Device, abmTokenID uint) (int64, *uint, error) {
	s.mu.Lock()
	s.IngestMDMAppleDevicesFromDEPSyncFuncInvoked = true
	s.mu.Unlock()
	return s.IngestMDMAppleDevicesFromDEPSyncFunc(ctx, devices, abmTokenID)
}
...
func (s *DataStore) GetABMTokenOrgNamesForTeam(ctx context.Context, teamID *uint) ([]string, error) {
	s.mu.Lock()
	s.GetABMTokenOrgNamesForTeamFuncInvoked = true
	s.mu.Unlock()
	return s.GetABMTokenOrgNamesForTeamFunc(ctx, teamID)
}
