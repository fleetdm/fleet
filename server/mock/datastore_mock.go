...
type SetOrUpdateHostDiskEncryptionKeyFunc func(ctx context.Context, hostID uint, encryptedBase64Key string, clientError string) error
...
func (s *DataStore) SetOrUpdateHostDiskEncryptionKey(ctx context.Context, hostID uint, encryptedBase64Key string, clientError string) error {
	s.mu.Lock()
	s.SetOrUpdateHostDiskEncryptionKeyFuncInvoked = true
	s.mu.Unlock()
	return s.SetOrUpdateHostDiskEncryptionKeyFunc(ctx, hostID, encryptedBase64Key, clientError)
}
