...
type CleanMacOSMDMLockFunc func(ctx context.Context, hostID uint) error
...
func (s *DataStore) CleanMacOSMDMLock(ctx context.Context, hostID uint) error {
	s.mu.Lock()
	s.CleanMacOSMDMLockFuncInvoked = true
	s.mu.Unlock()
	return s.CleanMacOSMDMLockFunc(ctx, hostID)
}
