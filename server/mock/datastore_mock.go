...
func (s *DataStore) OverwriteQueryResultRows(ctx context.Context, rows []*fleet.ScheduledQueryResultRow, maxQueryReportRows int, currentCount int) (rowsAdded int, rejected bool, err error) {
	s.mu.Lock()
