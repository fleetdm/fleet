...
// This function is a copy of the ParseCertificateRequest function from the std x509 package
// Only modification done was to support invalid characters in the certificate CommonName field.
// The certificates generated by a Windows device during MDM enrollment  where not being parsed
// correctly by the std x509 package, to workaround this we used a modified version of the ASN.1
// isPrintable function that allows invalid characters
// See isPrintable implementation here
// https://github.com/golang/go/blob/e126572f8a91d42b86242012012d0cad4507dca8/src/encoding/asn1/asn1.go#L433
// The std lib modification only worked localled and required to to run the following patch to the std x509 package:
// https://github.com/fleetdm/fleet/blob/main/tools/mdm/windows/poc-mdm-server/patch/patch.go
// As this solution is a bit dirty and does not scale, we have wrapped a custom version of
// ParseCertificateRequest with the required changes on ParseCertificateRequestFromWindowsDevice()
// The invalid characters are: '!' and 0x00
// Example of a certificate with invalid characters in the CommonName field:
// Common Name: F717C0F0-5F68-4AC3-A341-01B254!4219DFB0A902F747A9C4FD43C8CE36CE
// The new characters were added to isPrintable() below
