...
const (
	...
	// DMClientPollIntervalLocURI is the DMClient Poll node Fleet writes to tune the Windows MDM poll cadence
	// (the aggressive default vs the relaxed steady-state for hosts that can be woken on demand by fleetd).
