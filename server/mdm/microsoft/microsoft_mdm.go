...
const (
	...
	BinarySecurityTokenDeviceEnroll   = "http://schemas.microsoft.com/5.0.0.0/ConfigurationManager/Enrollment/DeviceEnrollmentUserToken"
	BinarySecurityTokenAzureJWTEnroll = "urn:ietf:params:oauth:token-type:jwt"
)
