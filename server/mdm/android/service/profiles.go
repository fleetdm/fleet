...
func ReconcileProfiles(ctx context.Context, ds fleet.Datastore, logger *logging.Logger, licenseKey string, androidAgentConfig config.AndroidAgentConfig) error {
...
func ReconcileProfilesWithClient(ctx context.Context, ds fleet.Datastore, logger *logging.Logger, licenseKey string, client androidmgmt.Client, androidAgentConfig config.AndroidAgentConfig) error {
