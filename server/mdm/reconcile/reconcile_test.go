...
func (e *testEntity) HasBrokenLabel() bool {
	// Iterate the two slices separately: append(e.includeLabels, e.excludeLabels...)
	// can write into e.includeLabels' backing array when it has spare capacity,
	// leaking state across assertions.
