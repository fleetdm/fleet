...
func createInviteEndpoint(ctx context.Context, request any, svc fleet.Service) (fleet.Errorer, error) {
...
func listInvitesEndpoint(ctx context.Context, request any, svc fleet.Service) (fleet.Errorer, error) {
...
func updateInviteEndpoint(ctx context.Context, request any, svc fleet.Service) (fleet.Errorer, error) {
...
func deleteInviteEndpoint(ctx context.Context, request any, svc fleet.Service) (fleet.Errorer, error) {
...
func verifyInviteEndpoint(ctx context.Context, request any, svc fleet.Service) (fleet.Errorer, error) {
