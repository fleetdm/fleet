	...
	cases := []struct {
		...
		},
		{
			...
			profile: customSCEPForValidation("$FLEET_VAR_NDES_SCEP_CHALLENGE_ndesName", "$FLEET_VAR_NDES_SCEP_PROXY_URL_ndesName",
				"$FLEET_VAR_NDES_SCEP_CHALLENGE_ndesName",
				"com.apple.security.scep"),
			errMsg: "$FLEET_VAR_NDES_SCEP_CHALLENGE_ndesName is already present in configuration profile",
		},
		{
			name: "NDES url shows up an extra time",
			profile: customSCEPForValidation("$FLEET_VAR_NDES_SCEP_CHALLENGE_ndesName", "$FLEET_VAR_NDES_SCEP_PROXY_URL_ndesName",
				"$FLEET_VAR_NDES_SCEP_PROXY_URL_ndesName",
				"com.apple.security.scep"),
			errMsg: "$FLEET_VAR_NDES_SCEP_PROXY_URL_ndesName is already present in configuration profile",
		},
		{
			name:    "NDES challenge missing",
			profile: customSCEPForValidation("challenge", "$FLEET_VAR_NDES_SCEP_PROXY_URL_ndesName", "Name", "com.apple.security.scep"),
			errMsg:  fleet.NDESSCEPVariablesMissingErrMsg,
		},
		{
			name: "NDES url missing",
			profile: customSCEPForValidation("$FLEET_VAR_NDES_SCEP_CHALLENGE_ndesName", "https://bozo.com", "Name",
				"com.apple.security.scep"),
			errMsg: fleet.NDESSCEPVariablesMissingErrMsg,
		},
		{
