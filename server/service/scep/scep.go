...
// TODO: Put this in ee/server/service/fleetd/scep?

const (
	scepChallenge    = "challenge"
	scepPath         = "/api/fleet/orbit/scep"
	scepValidityDays = 365
	scepRenewalDays  = 14 // This isn't actually used by Fleet server code right now.
)
...
func RegisterSCEP(
	...
	var signer scepserver.CSRSignerContext = scepserver.SignCSRAdapter(scep_depot.NewSigner(
		...
		scep_depot.WithAllowRenewalDays(scepRenewalDays),
	))
	...
	scepLogger := kitlog.With(logger, "component", "http-fleetd-scep")
