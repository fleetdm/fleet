...
},
{
  ...
  "decorations": {
	...
	// TODO: add a global flag deletion test (POST to /trigger endpoint)
	// - should delete whole table, across diff queries
	// - should prevent results data from being written

	// TODO: add 1000 row limit test
}
