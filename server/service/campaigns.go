...
func createDistributedQueryCampaignEndpoint(ctx context.Context, request any, svc fleet.Service) (fleet.Errorer, error) {
...
func createDistributedQueryCampaignByIdentifierEndpoint(ctx context.Context, request any, svc fleet.Service) (fleet.Errorer,
	error) {
