...
func getGlobalScheduleEndpoint(ctx context.Context, request any, svc fleet.Service) (fleet.Errorer, error) {
...
func globalScheduleQueryEndpoint(ctx context.Context, request any, svc fleet.Service) (fleet.Errorer, error) {
...
func modifyGlobalScheduleEndpoint(ctx context.Context, request any, svc fleet.Service) (fleet.Errorer, error) {
...
func deleteGlobalScheduleEndpoint(ctx context.Context, request any, svc fleet.Service) (fleet.Errorer, error) {
