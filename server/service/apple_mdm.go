...
type updateABMTokenTeamsRequest struct {
	TokenID      uint  `url:"id"`
	MacOSTeamID  *uint `json:"macos_fleet_id" renamedfrom:"macos_team_id"`
	IOSTeamID    *uint `json:"ios_fleet_id" renamedfrom:"ios_team_id"`
	IPadOSTeamID *uint `json:"ipados_fleet_id" renamedfrom:"ipados_team_id"`
}
