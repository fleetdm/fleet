...
func searchTargetsEndpoint(ctx context.Context, request any, svc fleet.Service) (fleet.Errorer, error) {
...
func countTargetsEndpoint(ctx context.Context, request any, svc fleet.Service) (fleet.Errorer, error) {
