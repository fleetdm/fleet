...
func TestMDMConfig(t *testing.T) {
	...
	testCases := []struct {
		...
		},
		{
			...
			expectedError: `enable_create_local_admin_account is required to be enabled when using "standard" for the end_user_local_account_type`,
		},
		{
			...
			expectedError: `enable_create_local_admin_account is required to be enabled when using "none" for the end_user_local_account_type`,
		},
	}
