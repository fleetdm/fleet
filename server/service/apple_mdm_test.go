...
func TestMDMAuthenticateManualEnrollment(t *testing.T) {
	ds := new(mock.Store)
	mdmLifecycle := mdmlifecycle.New(ds, kitlog.NewNopLogger(), func(_ context.Context, _ *fleet.User, _ fleet.ActivityDetails) error { return nil })
...
func TestMDMAuthenticateSCEPRenewal(t *testing.T) {
	...
	mdmLifecycle := mdmlifecycle.New(ds, kitlog.NewNopLogger(), func(_ context.Context, _ *fleet.User, _ fleet.ActivityDetails) error {
...
func TestMDMTokenUpdate(t *testing.T) {
	...
	mdmLifecycle := mdmlifecycle.New(ds, kitlog.NewNopLogger(), func(_ context.Context, user *fleet.User, activity fleet.ActivityDetails) error {
