...
type AuthenticateHostFunc func(ctx context.Context, nodeKey string) (hostID uint, debug bool, err error)
...
func (s *TLSService) AuthenticateHost(ctx context.Context, nodeKey string) (hostID uint, debug bool, err error) {
