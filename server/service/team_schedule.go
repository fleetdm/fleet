...
func getTeamScheduleEndpoint(ctx context.Context, request any, svc fleet.Service) (fleet.Errorer, error) {
...
func teamScheduleQueryEndpoint(ctx context.Context, request any, svc fleet.Service) (fleet.Errorer, error) {
...
func modifyTeamScheduleEndpoint(ctx context.Context, request any, svc fleet.Service) (fleet.Errorer, error) {
...
func deleteTeamScheduleEndpoint(ctx context.Context, request any, svc fleet.Service) (fleet.Errorer, error) {
