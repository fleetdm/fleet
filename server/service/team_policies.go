...
func teamPolicyEndpoint(ctx context.Context, request any, svc fleet.Service) (fleet.Errorer, error) {
...
func listTeamPoliciesEndpoint(ctx context.Context, request any, svc fleet.Service) (fleet.Errorer, error) {
...
func countTeamPoliciesEndpoint(ctx context.Context, request any, svc fleet.Service) (fleet.Errorer, error) {
...
func getTeamPolicyByIDEndpoint(ctx context.Context, request any, svc fleet.Service) (fleet.Errorer, error) {
...
func deleteTeamPoliciesEndpoint(ctx context.Context, request any, svc fleet.Service) (fleet.Errorer, error) {
...
func modifyTeamPolicyEndpoint(ctx context.Context, request any, svc fleet.Service) (fleet.Errorer, error) {
