...
func TestTeamPoliciesAuth(t *testing.T) {
	...
	ds.ListTeamPoliciesFunc = func(ctx context.Context, teamID uint, opts fleet.ListOptions) (tpol, ipol []*fleet.Policy, err error) {
		return nil, nil, nil
	}
	...
	for _, tt := range testCases {
		t.Run(tt.name, func(t *testing.T) {
			...
			_, _, err = svc.ListTeamPolicies(ctx, 1, fleet.ListOptions{})
