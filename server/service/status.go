...
func statusResultStoreEndpoint(ctx context.Context, req any, svc fleet.Service) (fleet.Errorer, error) {
...
func statusLiveQueryEndpoint(ctx context.Context, req any, svc fleet.Service) (fleet.Errorer, error) {
	var resp statusResponse
