...
func attachFleetAPIRoutes(r *mux.Router, svc fleet.Service, config config.FleetConfig,
	...
	ue.POST("/api/v1/fleet/hosts/{host_id:[0-9]+}/software/install/{software_title_id:[0-9]+}", installSoftwareTitleEndpoint, installSoftwareRequest{})

	// Sofware installers
	ue.GET("/api/_version_/fleet/software/package/{title_id:[0-9]+}", getSoftwareInstallerEndpoint, getSoftwareInstallerRequest{})
	ue.POST("/api/_version_/fleet/software/package", uploadSoftwareInstallerEndpoint, uploadSoftwareInstallerRequest{})
	ue.DELETE("/api/_version_/fleet/software/package/{title_id:[0-9]+}", deleteSoftwareInstallerEndpoint, deleteSoftwareInstallerRequest{})
