...
func attachFleetAPIRoutes(r *mux.Router, svc fleet.Service, config config.FleetConfig,
	...
	ue.POST("/api/_version_/fleet/hosts/{id:[0-9]+}/managed_local_account/rotate", rotateManagedLocalAccountPasswordEndpoint, rotateManagedLocalAccountPasswordRequest{})
