...
func attachFleetAPIRoutes(r *mux.Router, svc fleet.Service, config config.FleetConfig,
	...
	ue.GET("/api/_version_/fleet/hosts/search", searchHostsEndpoint, searchHostsRequest{})
	...
	ue.GET("/api/_version_/fleet/labels/summary", getLabelsSummaryEndpoint, getGenericSpecRequest{})
