...
func attachFleetAPIRoutes(r *mux.Router, svc fleet.Service, config config.FleetConfig,
	...
	oeAppleMDM.POST("/api/fleet/orbit/setup_experience/start", postOrbitStartSetupExperienceEndpoint, orbitPostStartSetupExperienceRequest{})
	oeAppleMDM.POST("/api/fleet/orbit/setup_experience/status", postOrbitSetupExperienceStatusEndpoint, orbitPostSetupExperienceStatusRequest{})
