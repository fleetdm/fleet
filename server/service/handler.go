...
func attachFleetAPIRoutes(r *mux.Router, svc fleet.Service, config config.FleetConfig,
	...
	ue.POST("/api/_version_/fleet/teams", createTeamEndpoint, createTeamRequest{}, teamResponse{})
	...
	ue.GET("/api/_version_/fleet/hosts", listHostsEndpoint, listHostsRequest{}, listHostsResponse{})
	ue.POST("/api/_version_/fleet/hosts/delete", deleteHostsEndpoint, deleteHostsRequest{}, deleteHostsResponse{})
