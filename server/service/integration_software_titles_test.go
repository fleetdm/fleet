...
func (s *integrationMDMTestSuite) TestSoftwareTitleDisplayNames() {
	...
	s.Assert().ElementsMatch(fleet.TranslateLegacySoftwareCategoryNames([]string{"Developer tools", "Browsers"}), stResp.SoftwareTitle.SoftwarePackage.Categories)
	...
	s.Assert().ElementsMatch(fleet.TranslateLegacySoftwareCategoryNames([]string{"Developer tools", "Browsers"}), stResp.SoftwareTitle.AppStoreApp.Categories)
