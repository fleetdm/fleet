...
func listSoftwareEndpoint(ctx context.Context, request any, svc fleet.Service) (fleet.Errorer, error) {
...
func listSoftwareVersionsEndpoint(ctx context.Context, request any, svc fleet.Service) (fleet.Errorer, error) {
	req := request.(*listSoftwareRequest)
...
func getSoftwareEndpoint(ctx context.Context, request any, svc fleet.Service) (fleet.Errorer, error) {
...
func countSoftwareEndpoint(ctx context.Context, request any, svc fleet.Service) (fleet.Errorer, error) {
