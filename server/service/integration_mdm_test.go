...
func (s *integrationMDMTestSuite) TestVPPApps() {
	...
	t.Run("vpp apps with labels", func(t *testing.T) {
		...
		activityData = `{"team_name": "%s", "software_title": "%s", "app_store_id": "%s", "icon_url": null, "team_id": %d, "software_title_id": %d, "platform": "%s", "self_service": false, "labels_include_any": [{"id": %d, "name": %q}]}`
		...
		activityData = `{"team_name": "%s", "software_title": "%s", "app_store_id": "%s", "icon_url": null, "team_id": %d, "platform": "%s", "labels_include_any": [{"id": %d, "name": %q}]}`
	...
	s.lastActivityMatches(fleet.ActivityDeletedAppStoreApp{}.ActivityName(),
		fmt.Sprintf(`{"team_name": "%s", "software_title": "%s", "app_store_id": "%s", "icon_url": null, "team_id": %d, "platform": "%s"}`, team.Name,
