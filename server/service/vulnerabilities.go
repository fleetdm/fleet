...
func listVulnerabilitiesEndpoint(ctx context.Context, req any, svc fleet.Service) (fleet.Errorer, error) {
...
func getVulnerabilityEndpoint(ctx context.Context, req any, svc fleet.Service) (fleet.Errorer, error) {
