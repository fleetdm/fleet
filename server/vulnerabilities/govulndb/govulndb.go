...
//
// Fleet does not reach vuln.go.dev directly. A job in fleetdm/vulnerabilities publishes the
// database as a release asset, keeping a single egress point for restricted deployments. See
// README.md for the artifact contract.
package govulndb
