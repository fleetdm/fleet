...
func TestParser(t *testing.T) {
	t.Run("parseMSRCXML", func(t *testing.T) {
		...
		expectedProducts := []msrc_input.ProductXML{
			{ProductID: "11568", Name: "Windows 10 Version 1809 for 32-bit Systems"},
			{ProductID: "11569", Name: "Windows 10 Version 1809 for x64-based Systems"},
			{ProductID: "11570", Name: "Windows 10 Version 1809 for ARM64-based Systems"},
			{ProductID: "11571", Name: "Windows Server 2019"},
			...
			{ProductID: "11713", Name: "Windows 10 Version 1909 for x64-based Systems"},
			{ProductID: "11714", Name: "Windows 10 Version 1909 for ARM64-based Systems"},
			{ProductID: "11896", Name: "Windows 10 Version 21H1 for x64-based Systems"},
			{ProductID: "11897", Name: "Windows 10 Version 21H1 for ARM64-based Systems"},
			{ProductID: "11898", Name: "Windows 10 Version 21H1 for 32-bit Systems"},
			{ProductID: "11923", Name: "Windows Server 2022"},
			{ProductID: "11924", Name: "Windows Server 2022 (Server Core installation)"},
			{ProductID: "11800", Name: "Windows 10 Version 20H2 for x64-based Systems"},
			{ProductID: "11801", Name: "Windows 10 Version 20H2 for 32-bit Systems"},
			{ProductID: "11802", Name: "Windows 10 Version 20H2 for ARM64-based Systems"},
			{ProductID: "11803", Name: "Windows Server, version 20H2 (Server Core Installation)"},
			{ProductID: "11926", Name: "Windows 11 for x64-based Systems"},
			{ProductID: "11927", Name: "Windows 11 for ARM64-based Systems"},
			{ProductID: "11929", Name: "Windows 10 Version 21H2 for 32-bit Systems"},
			{ProductID: "11930", Name: "Windows 10 Version 21H2 for ARM64-based Systems"},
			{ProductID: "11931", Name: "Windows 10 Version 21H2 for x64-based Systems"},
			{ProductID: "10729", Name: "Windows 10 for 32-bit Systems"},
			{ProductID: "10735", Name: "Windows 10 for x64-based Systems"},
			{ProductID: "10852", Name: "Windows 10 Version 1607 for 32-bit Systems"},
			{ProductID: "10853", Name: "Windows 10 Version 1607 for x64-based Systems"},
			{ProductID: "10816", Name: "Windows Server 2016"},
			{ProductID: "10855", Name: "Windows Server 2016  (Server Core installation)"},
			{ProductID: "10481", Name: "Windows 8.1 for 32-bit systems"},
			{ProductID: "10482", Name: "Windows 8.1 for x64-based systems"},
			{ProductID: "10484", Name: "Windows RT 8.1"},
			{ProductID: "10378", Name: "Windows Server 2012"},
			{ProductID: "10379", Name: "Windows Server 2012 (Server Core installation)"},
			{ProductID: "10483", Name: "Windows Server 2012 R2"},
			{ProductID: "10543", Name: "Windows Server 2012 R2 (Server Core installation)"},
			{ProductID: "10047", Name: "Windows 7 for 32-bit Systems Service Pack 1"},
			{ProductID: "10048", Name: "Windows 7 for x64-based Systems Service Pack 1"},
			{ProductID: "9312", Name: "Windows Server 2008 for 32-bit Systems Service Pack 2"},
			{ProductID: "10287", Name: "Windows Server 2008 for 32-bit Systems Service Pack 2 (Server Core installation)"},
			{ProductID: "9318", Name: "Windows Server 2008 for x64-based Systems Service Pack 2"},
			{ProductID: "9344", Name: "Windows Server 2008 for x64-based Systems Service Pack 2 (Server Core installation)"},
