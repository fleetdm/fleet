...
[Team enroll secrets](https://fleetdm.com/docs/using-fleet/adding-hosts#automatically-adding-hosts-to-a-team) allow you to automatically assign a host to a team.
