...
<#
.SYNOPSIS
    CIS Windows 11 Enterprise Benchmark v4.0.0 - Audit Policy Remediation

.DESCRIPTION
    Configures Advanced Audit Policy settings to meet CIS Windows 11 Enterprise Benchmark v4.0.0
