...
<#
.SYNOPSIS
    CIS Windows 11 Enterprise Benchmark v4.0.0 - Account and Password Policy Remediation

.DESCRIPTION
    Configures account lockout and password policies to meet CIS Windows 11 Enterprise Benchmark v4.0.0
