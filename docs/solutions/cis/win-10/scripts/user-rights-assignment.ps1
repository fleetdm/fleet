...
<#
.SYNOPSIS
    CIS Windows 10 Enterprise Benchmark v3.0.0 - User Rights Assignment Remediation

.DESCRIPTION
    Configures user rights assignments (privileges) to meet CIS Windows 10 Enterprise Benchmark v3.0.0
