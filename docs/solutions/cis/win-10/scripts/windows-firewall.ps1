...
<#
.SYNOPSIS
    CIS Windows 10 Enterprise Benchmark v3.0.0 - Windows Firewall Remediation

.DESCRIPTION
    Configures Windows Firewall settings to meet CIS Windows 10 Enterprise Benchmark v3.0.0
