...
<#
.SYNOPSIS
    CIS Windows 10 Enterprise Benchmark v3.0.0 - Security Registry Settings Remediation

.DESCRIPTION
    Configures common security registry settings to meet CIS Windows 10 Enterprise Benchmark v3.0.0
