...
Fleet allows you to schedule queries that run against your enrolled hosts at user-defined intervals. You can also schedule groups of queries (called packs). To view or create packs, select "Schedule" from the top navigation and click "Advanced" from the top right of the page.
