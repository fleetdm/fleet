...
| enable_host_status_webhook    | boolean | body | _Webhook settings_. If a host has not communicated with Fleet in the specified number of days, it will be removed.                                                                 |
