...
Fleet requires at least MySQL version 8.0.44, and is tested using the InnoDB storage engine [with versions 8.0.44, 8.4.8, and 9.6.0](https://github.com/fleetdm/fleet/blob/main/.github/workflows/test-go.yaml#L73-L90).
