...
The Fleet application contains two single static binaries which provide web based administration, REST API, and [CLI interface](https://fleetdm.com/guides/fleetctl) to Fleet.
