...
```json
{
  ...
  "mdm": {
    ...
    "software": ["path/to/installer.pkg","path/to/installer.msi"],
...
| software                           | list    | body  | A list of software installers (PKG, DMG, MSI, and EXE) to add so they get installed during enrollment. |
