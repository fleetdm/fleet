...
| connected_to_fleet   | string  | query | Filter hosts that are connected and controlled by your Fleet server. Some hosts can be enrolled in MDM solution "Fleet" but pointing to other Fleet servers and not yours.                                                                                                                            |
