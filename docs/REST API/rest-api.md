...
Keep in mind that any failure when uploading a file block (like a network error) will result on a failed carved file. osquery 5.22.0 will retry uploading blocks three times before erroring out.
