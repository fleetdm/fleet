...
| script_batch_execution_id       | integer | query | The ID of a batch-run script execution to filter hosts by.  If included, must also supply a `script_batch_execution_status`.                                                                                                                                                                                                                                                                                                |
| script_batch_execution_status       | string | query | The status of the batch script run to filter hosts by. One of: `ran`, `pending`, `errored`. Defaults to `success` if `script_batch_execution_id` is set. |
