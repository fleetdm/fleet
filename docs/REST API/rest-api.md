...
| allow_byod_wipe                   | boolean | _Available in Fleet Premium._ Hosts that are "Unassigned" and manually enrolled (BYOD) Apple hosts can be wiped if set to true. Already-enrolled hosts will have their permissions updated at the next SCEP certificate renewal. (Default: `true`) |
| allow_byod_lock                   | boolean | _Available in Fleet Premium._ Hosts that are "Unassigned" and manually enrolled (BYOD) Apple hosts can be locked if set to true. Already-enrolled hosts will have their permissions updated at the next SCEP certificate renewal. (Default: `true`) |
