...
| alternate_sso_url                 | string  | An optional URL to use for SSO callbacks when different from the server URL. This is useful when you have separate URLs for admin access vs agent/API access.          |
