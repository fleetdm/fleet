...
The `agent_options`, `sso_settings`, `smtp_settings`, and `email` fields are only returned for admin and GitOps users with global access (see the [Role-based access guide](https://fleetdm.com/guides/role-based-access)).
