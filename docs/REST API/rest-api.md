...
| enable_managed_local_account     | boolean | _Available in Fleet Premium._ During Setup Assistant, a managed local account will be created on macOS hosts that belong to no team if set to true. |
