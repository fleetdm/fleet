...
| script_batch_execution_status       | string | query | The status of the batch script run to filter hosts by. One of: `ran`, `pending`, `errored`. Must be supplied if `script_batch_execution_id` is set.   |
