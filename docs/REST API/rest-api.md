...
| custom_settings                   | list    | body  | _mdm.macos_settings settings_. Hosts that belong to no team and are members of specified labels and are enrolled into Fleet's MDM will have custom profiles applied. |
