...
| report_cap                        | integer | The maximum number of results to store per report before the report is clipped. If you have more hosts than this, the limit is the number of hosts instead. If increasing this cap, we recommend enabling reports for one report at time and monitoring your infrastructure. (Default: `1000`) |
