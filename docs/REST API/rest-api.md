...
| windows_entra_tenant_ids          | array | _Available in Fleet Premium._ Add tenants to connect to Fleet, to enable automatic (Autopilot) and manual enrollment by end user (**Settings > Accounts > Access work or school** on Windows). Find your **Tenant ID**, on [Microsoft Entra ID > Home](https://entra.microsoft.com/#home). |
  ...
  "software_title": {
    ...
    "software_package": {
      ...
      "automatic_install_policies": [
        {
          "id": 343,
          "name": "[Install software] Google Chrome",
        }
      ],
      "status": {
        "installed": 3,
