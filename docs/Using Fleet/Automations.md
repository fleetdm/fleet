...
Activity automations are triggered when an activity happens in Fleet (queries, scripts, logins, etc). See a list of all activities [here](../Using%20Fleet/Audit-logs.md).
