...
### Format
1. Share screen and open GitHub pull requests filtered to authored by anyone in the product group.
2. Call out verbally any PRs open for more than the time to merge KPI goal (24 hours).
3. Share screen and open the team's GitHub Projects board.
4. Call on each participant and filter the project board to that assignee.
6. Participant answers the questions in the agenda below. If there are blockers, they are added to the parking lot and the standup continues.
7. Call on the next participant until everyone, including the ritual DRI, has provided an update. 
