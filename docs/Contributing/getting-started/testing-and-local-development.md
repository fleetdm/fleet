...
which already have this configured, or to [configure an alternate server for this workflow](../mdm/windows/windows-autopilot.md#setting-up-a-custom-domain-with-ngrok).
