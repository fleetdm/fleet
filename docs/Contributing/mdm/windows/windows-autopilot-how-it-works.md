...
- [Windows MDM architecture](windows-mdm-architecture.md): SyncML, CSPs, poll schedules
- [Setup experience overview](../../setup-experience/setup-experience-overview.md): Setup experience flow across all platforms
