...
Unlike the [Fleet REST API documentation](../Using-Fleet/rest-api/README.md), the API routes in this document are only intended for use by the Fleet UI and fleetctl clients.
