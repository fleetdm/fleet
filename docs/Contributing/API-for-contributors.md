...
`/api/latest/fleet/results/websockets`
...
```
const socket = new WebSocket('wss://<your-base-url>/api/latest/fleet/results/websockets');
...
```
const socket = new SockJS(`<your-base-url>/api/latest/fleet/results`, undefined, {});
