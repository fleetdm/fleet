...
| profiles  | json   | body  | An array of objects, consisting of two properties. `profile` base64-encoded .mobileconfig (macOS) or XML (Windows) file and `labels` array of strings (label names).                                        |
