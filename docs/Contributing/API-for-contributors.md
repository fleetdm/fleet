...
- [Run live query (deprecated)](#run-live-query-deprecated)
...
### Run live query (deprecated)

> This endpoint has been replaced in Fleet's REST API with the updated [Run live query](https://fleetdm.com/docs/rest-api/rest-api#run-live-query) endpoint for improved compatibility with many HTTP clients. It is maintained for backwards compatibility.
