...
| software                                   | list   | body  | The list of objects consists of `url` to the software package (PKG, MSI, EXE or DEB),`install_script` - command that Fleet runs to install software, `pre_install_query` - condition query that determines if the install will proceed, and `post_install_script` that runs after software install.   |
...
| software  | array  | body  | An array of objects containing `url` to the software package (PKG, MSI, EXE or DEB),`install_script` - command that Fleet runs to install software, `pre_install_query` - condition query that determines if the install will proceed, and `post_install_script` that runs after software install. |
