...
> Follow the instructions [here](https://fleetdm.com/docs/using-fleet/enroll-hosts#enroll-chromebooks-with-fleetd-chrome-extension) for installing the fleetd Chrome extension, with the following modifications:
