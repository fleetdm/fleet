...
Fleets and Access Control in Fleet enable organizations to manage user access to devices, reports, and other resources based on fleet membership and roles. This document provides insights into the design decisions, system components, and interactions specific to the Fleets and Access Control functionality.

## Architecture overview

The Fleets and Access Control architecture enables the organization of devices and users into fleets, and the management of user access to resources based on fleet membership and roles.
...
- [Fleets](../../product-groups/orchestration/teams.md) - Detailed documentation on fleets