...
Check out this Loom demo video that walks through creating fleets seed data:
...
```sh
./tools/api/fleet/fleets/create_free
```
...
```sh
./tools/api/fleet/fleets/create_premium
```
...
```sh
./tools/api/fleet/fleets/create_figma
```
...
### Import reports and policies

After seeding users and fleets, check out [importing reports and policies](https://fleetdm.com/docs/using-fleet/standard-query-library#importing-the-reports-in-fleet) from Fleet's [standard query library](https://fleetdm.com/queries).
