...
Check out this Loom demo video that walks through creating fleets (formally "teams") seed data:
...
After seeding users and fleets, check out [importing queries and policies](https://fleetdm.com/docs/using-fleet/standard-query-library#importing-the-queries-in-fleet) from Fleet's [standard query library](https://fleetdm.com/queries).
