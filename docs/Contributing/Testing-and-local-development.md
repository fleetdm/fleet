...
The CLI will output instructions for you to follow, a couple of notes on those:

1. To login into https://identity.apple.com/pushcert you can use your ABM account generated in the previous step.
2. Save all the certificates and keys in a safe place.
