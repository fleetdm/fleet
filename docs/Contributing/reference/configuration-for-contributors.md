...
This configuration option is not production ready. This hasn't been tested by Fleet. There will be conflicts between custom OS updates / FileVault configuration profiles and the profiles Fleet for these features under-the-hood.
