...
- "labels_include_any": Target hosts that have any label in the array.
- "labels_exclude_any": Target hosts that don't have any label in the array.
- "software_icon_url": URL of the icon that will added to the software title.
...
```json
{
  ...
  "self_service": true,
  "software_title_id": 2234,
  "software_icon_url":"https://fleet.server.com/software_icons/f04e275e-6790-4174-856c-47eb22a631fa.png" 
  "labels_include_any": [
    {
      "name": "Engineering",
      "id": 12
...
```json
{
  ...
  "software_title_id": 123,
  "software_icon_url": "https://is1-ssl.mzstatic.com/image/thumb/Purple221/v4/d1/2f/ff/d12fff5b-fe7b-a41b-e55a-96606c7193b1/electron.png/512x512bb.png",
  "app_store_id": "1234567",
  "platform": "darwin",
  "self_service": true,
  "team_name": "Workstations",
