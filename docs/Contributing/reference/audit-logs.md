...
Generated when a custom host vital definition is created.

This activity contains the following fields:
- "custom_host_vital_id": the id of the new custom host vital.
- "custom_host_vital_name": the name of the new custom host vital.
...
Generated when a custom host vital definition is renamed.

This activity contains the following fields:
- "custom_host_vital_id": the id of the custom host vital.
- "custom_host_vital_name": the new name of the custom host vital.
...
{
	"custom_host_vital_id": 123,
	"custom_host_vital_name": "Department"
}
```

## deleted_custom_host_vital

Generated when a custom host vital definition is deleted.

This activity contains the following fields:
- "custom_host_vital_id": the id of the custom host vital.
- "custom_host_vital_name": the name of the custom host vital.
...
Generated when a host's value for a custom host vital is set or updated.
