...
An alphanumeric secret for the Simple Certificate Enrollment Protocol (SCEP). Generate a unique, static secret 32 characters in length and only include alphanumeric characters.
