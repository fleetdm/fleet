...
See [TLS certificate considerations](https://fleetdm.com/docs/deploy/reference-architectures#tls-certificate) for more information about certificates and Fleet.
