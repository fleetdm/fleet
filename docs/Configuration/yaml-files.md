...
When making software packages available for install or installable by policy automation, you can include one of the following arrays of labels to narrow the scope of software installs:
