...
- `$FLEET_VAR_HOST_END_USER_EMAIL_IDP`: host's IdP email.
- `$FLEET_VAR_HOST_END_USER_EMAIL_NICKNAME`: nickname portion of the email (e.g. john from john@fleetdm.com).
- `$FLEET_VAR_HOST_END_USER_GROUPS`: comma separated IdP groups that host belongs to.
