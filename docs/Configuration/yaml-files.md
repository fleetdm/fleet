...
Currently, you can specify `install_software` in the [`policies` YAML](#policies) to automatically install software when a host fails a policy. [Automatic install support for Fleet-maintained apps](https://github.com/fleetdm/fleet/issues/29584) is coming soon.
