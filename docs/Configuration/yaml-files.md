...
- `create_local_user_account` is the object that specify Platform SSO configuration profile and SSO extension software used to automatically create local user accountwhen the user first sets up their macOS host.
