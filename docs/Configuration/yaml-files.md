...
The `software` section allows you to configure packages, store apps (Apple App Store and Android Play Store), and Fleet-maintained apps that you want to install on your hosts.
