...
- `apple_require_hardware_attestation` specifies whether or not to require all Apple MDM devices to complete a Hardware Attestation challenge as part of enrollment.
