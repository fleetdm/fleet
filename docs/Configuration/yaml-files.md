...
- `display_name` is the custom name that will be displayed in the UI. If not set, the name [extracted from the package](https://fleetdm.com/guides/deploy-software-packages#package-metadata-extraction) is used until Fleet collects software inventory, after which the inventory name is used.
