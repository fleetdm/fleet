...
- `apple_require_hardware_attestation` specifies whether or not to require Apple Silicon macOS hosts to complete a Hardware Attestation challenge as part of DEP enrollment.
