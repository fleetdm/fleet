...
- `fleet_maintained_apps` is a list of apps maintained by Fleet. To find the `fleet_maintained_app_id`, head to **Software > Add software** and select a Fleet-maintained app. From there, select **Show details**.
