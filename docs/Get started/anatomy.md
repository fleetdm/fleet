...
A fleet is a group of hosts. Organize hosts into fleets to apply reports, policies, scripts, and other configurations tailored to their specific risk and compliance requirements. [Read the guide](https://fleetdm.com/guides/fleets).

## Report
A report in Fleet refers to an osquery query. Osquery uses basic SQL commands to request data from hosts. Use reports to manage, monitor, and identify threats on your devices. [Docs](https://fleetdm.com/docs/using-fleet/fleet-ui).
...
## Host vitals
Fleet's built-in reports for collecting and storing important device information.
