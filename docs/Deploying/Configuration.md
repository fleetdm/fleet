...
To enable this option, go to **Settings > Organization settings > single sign-on options** and check "Create user and sync permissions on login_" or [adjust your config](#sso-settings-enable-jit-provisioning).
