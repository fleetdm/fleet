...
Deploying this profile will deploy a SCEP certificate to your hosts. These certificates are valid for 1 year and 33 days and renew automatically about 30 days before expiration. When the certificate is renewed, the old certificate isn't removed from the keychain. To clean up the old certificate, you can run [this script](https://github.com/fleetdm/fleet/blob/31ec68e325801bfd2199191f70d021383a45161f/assets/scripts/delete-duplicate-scep-certificates.sh).
