...
In the early days of Windows PCs, disk imaging became the de facto approach for IT vendors for wanting to replicate OS settings across their fleets. Windows admins spent unimaginable amounts of time crafting a ‘golden image’ which was then applied to all newly purchased computers. 
