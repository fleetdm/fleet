...
* **macOS** followed suit, using scripts and MCX / MDM via configuration profiles to enforce similar security controls.
...
## The standardized path to enterprise security
