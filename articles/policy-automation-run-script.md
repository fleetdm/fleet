...
* Policy automation scripts are automatically attempted up to 3 total times. Each time the policy runs and fails, Fleet triggers the script again, up to a total of 3 attempts. If the host passes the policy, the retry count resets.
