...
If want to add your organization's logo, you can optionally set a logo for each background:
...
6. Send [these guided instructions](#how-to-turn-on-mdm-end-user-manual-migration) to your end users to complete the final few steps via Fleet Desktop.
