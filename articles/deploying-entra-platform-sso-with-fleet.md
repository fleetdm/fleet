...
On your Fleet server, select the team you want to deploy Platform SSO to. Navigate to Controls > OS Settings > Configuration profiles. Click the Add profile button, then find the `platform-sso-settings.mobileconfig` profile on your computer and upload it to Fleet.
