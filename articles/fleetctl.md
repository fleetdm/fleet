...
> Note: Unless a [logging destination](https://fleetdm.com/guides/log-destinations) is configured on your Fleet server, osquery-related logs will be stored locally on each device.
