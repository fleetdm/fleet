...
| Edit [custom OS settings](https://fleetdm.com/docs/rest-api/rest-api#add-custom-os-setting-configuration-profile)                                                               |          |            | ✅          | ✅    | ✅      |
| View all [custom OS settings]([https://fleetdm.com/docs/using-fleet/mdm-macos-settings](https://fleetdm.com/docs/rest-api/rest-api#list-custom-os-settings-configuration-profiles))                                                           |          |            | ✅          | ✅    | ✅      |
...
| Execute MDM commands on macOS and Windows hosts*                                                                                 |               |                | ✅              | ✅         |             |
| View results of MDM commands executed on macOS and Windows hosts*                                                                | ✅            | ✅             | ✅              | ✅         |             |
| Edit [team custom OS settings](https://fleetdm.com/docs/rest-api/rest-api#add-custom-os-setting-configuration-profile)                                                |               |                | ✅               | ✅         | ✅          |
