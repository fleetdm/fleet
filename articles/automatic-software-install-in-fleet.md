...
Following are some templates for the policy SQL queries for each package type. These templates are used when Fleet creates policies to automatically install software.
