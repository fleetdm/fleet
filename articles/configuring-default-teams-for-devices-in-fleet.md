# Configuring default fleets for macOS, iOS, and iPadOS devices in Fleet
...
### Configuring default fleets in Fleet

Follow these steps to assign default fleets to your devices:
...
2. **Edit the ABM token**:
   ...
   - Click **Edit** next to the ABM token for which you want to configure default fleets.

3. **Assign default fleets**:

   - In the modal, use the dropdowns to select the appropriate default fleet for each platform (macOS, iOS, and iPadOS).

4. **Save your changes**: 

   - After selecting the fleets, click **Save** to apply the changes. New devices will be automatically assigned to the selected fleets upon enrollment.

## Benefits of configuring default fleets
...
2. **Reduced errors**: Automating fleets assignments helps avoid misconfigurations and ensures that the right profiles and apps are installed on the correct devices.
...
<meta name="articleTitle" value="Configuring default fleets for macOS, iOS, and iPadOS devices in Fleet">
<meta name="authorFullName" value="JD Strong">
<meta name="authorGitHubUsername" value="spokanemac">
<meta name="category" value="guides">
<meta name="publishedOn" value="2024-09-12">
<meta name="description" value="This guide will walk you through configuring default fleets for devices using the Fleet web UI.">
