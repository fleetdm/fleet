...
Fleet currently has built-in conditional access integrations with Okta (macOS) and Entra (macOS and Windows).

For detailed setup instructions and to preview end user experience, see the guide for your identity provider:
