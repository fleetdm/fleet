...
macOS declaration profiles (configurations and assets) are verified with a [DDM StatusReport](https://developer.apple.com/documentation/devicemanagement/statusreport).
