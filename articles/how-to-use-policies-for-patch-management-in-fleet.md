...
> **Note:** Currently, **Patch when app is closed** can install an update while the app is still open. Follow [fleetdm/fleet#53919](https://github.com/fleetdm/fleet/issues/53919) for updates.
