...
The level of performance impact is derived from [a query's `stats` object](https://fleetdm.com/docs/api/rest-api#get-query), by totaling up milliseconds `stats.system_time_p50` and `stats.user_time_p50`:
