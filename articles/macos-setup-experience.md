...
2. In Fleet, navigate to the Hosts page and find your Mac. Make sure that the host's **MDM status** is set to "Pending."
  ...
  > New Macs purchased through Apple Business Manager appear in Fleet with MDM status set to "Pending." See our [automatic enrollment docs](https://fleetdm.com/guides/macos-mdm-setup#automatic-enrollment) for more information.
