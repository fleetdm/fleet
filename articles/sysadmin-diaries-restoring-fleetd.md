...
One potential solution is to resend the `fleetd` configuration profile. The new feature for [resending profiles](https://fleetdm.com/docs/api/rest-api#resend-configuration-profile) makes this easy to accomplish through the MDM interface.
