...
1. Add the uninstall script for [macOS](https://github.com/fleetdm/fleet/tree/main/it-and-security/lib/macos/scripts/uninstall-fleetd-macos.sh), [Windows](https://github.com/fleetdm/fleet/tree/main/it-and-security/lib/windows/scripts/uninstall-fleet-windows.ps1), or [Linux](https://github.com/fleetdm/fleet/blob/main/it-and-security/lib/linux/scripts/uninstall-fleetd-linux.sh) hosts to Fleet.
