...
> **Experimental feature**: Fleet is already using it internally, and it's a great time to start experimenting. Keep in mind that the API or configuration surface may change as it matures. This feature's experimental status will be reevaluated in Fleet 4.94.0.
...
For setup instructions, configuration options, and usage examples, see the [Fleet MCP README](https://github.com/fleetdm/fleet/tree/main/cmd/fleet-mcp).
