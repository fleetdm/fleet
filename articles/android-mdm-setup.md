...
If you ever delete your Android Enterprise in your [Google Admin console](https://admin.google.com), Android MDM will be turned off in Fleet, and the work profile will be deleted from all Android hosts. To re-enroll hosts, refer to the [Turn on](#turn-on) section.
