...
Currently, Fleet only supports apps from the United States (US) region. If the app is listed on the [Apple App Store](https://apps.apple.com/) with `/us` in the Apple App Store URL (e.g. https://apps.apple.com/us/app/slack/id618783545), then it's supported.
