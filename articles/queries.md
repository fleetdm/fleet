...
To create a scheduled query, be sure to set the interval to a value other than "Never" when [creating a query](#create-a-query). If the query has already been created, select the query and then select **Edit query** to set the interval.
