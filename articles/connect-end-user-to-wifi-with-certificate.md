...
Fleet automatically retries failed certificate delivery for macOS, iOS, iPadOS, Windows, and Android hosts. Apple MDM profiles and Android certificates are attempted up to 4 times (1 initial attempt + 3 retries). Learn more in the [4.38.0 release article](https://fleetdm.com/releases/fleet-4-38-0#failed-profile-redelivery).
