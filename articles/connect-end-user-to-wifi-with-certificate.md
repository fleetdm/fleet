...
3. Enter your **SCEP URL**, **Challenge URL**, and **Username** and **Password**. (The username should have been generated by Okta during Step 1.)
4. Select **Add CA**, then the Okta CA named "NDES" should appear in a table in Fleet. (Values can be edited by clicking the pencil icon if needed.)
