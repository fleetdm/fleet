...
For scripts, if a secret doesn't have the `$FLEET_SECRET_` prefix, it will be treated as a shell (macOS and Linux) or PowerShell (Windows) environment variable.
