...
> Unenroll action on Android hosts, sends wipe command via Android Management API. [Learn more](https://fleedtdm.com/docs/rest-api/rest-api#turn-off-hosts-mdm)
