...
For disk encryption policies, Windows enforces BitLocker, and macOS enforces FileVault. When configured, the MDM server can escrow recovery keys securely, and the enforcement mechanism confirms successful activation once encryption is enabled.
