...
4. Pick a [Fleet-maintained app](https://fleetdm.com/guides/fleet-maintained-apps) or an [app store app](https://fleetdm.com/guides/install-vpp-apps-on-macos-using-fleet#add-the-app-to-fleet), or upload a [custom package](https://fleetdm.com/guides/deploy-software-packages).
