...
4. Pick a [Fleet-maintained app](https://fleetdm.com/guides/fleet-maintained-apps), [app store app](https://fleetdm.com/guides/install-app-store-apps), or upload a [custom package](https://fleetdm.com/guides/deploy-software-packages).
