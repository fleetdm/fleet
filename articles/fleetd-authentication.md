...
- On Fleet premium you can define multiple enroll secrets globally ("Unassigned") and multiple enroll secrets for each fleet. Fleet will automatically join the device to the fleet that corresponds to the enroll secret.
