...
Sample queries are included in the configuration file ([queries-kubequery-fleet.yml](queries-kubequery-fleet.yml)). Modify the `team` value in this file to reflect the appropriate fleet (formerly "team") name for your environment and apply with `fleetctl`.
