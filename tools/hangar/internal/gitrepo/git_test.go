...
func TestParseBranchesRCGrouping(t *testing.T) {
	raw := strings.Join([]string{
		...
		ref("rc-minor-fleet-v4.88.0", "a", "s", "me", "3d", "refs/heads/rc-minor-fleet-v4.88.0"),
	...
	for _, want := range []string{"rc-minor-fleet-v4.88.0", "rc-patch-fleet-v4.88.1", "rc-minor-fleet-v4.88.0", "rc-minor-fleet-v4.86.0"} {
		if !names[want] {
