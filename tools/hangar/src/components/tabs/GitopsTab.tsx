        ...
        <button
          ...
          style={{
            ...
            ...(exists && !startDisabled
              ? {
                  // Destructive-overwrite variant: bright yellow with
                  // dark text. White-on-yellow (from the .primary
                  // class) is unreadable; flipping to navy gives the
                  // amber background the contrast it needs.
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
        ...
        <span
          style={{
            ...
            // Yellow pill needs dark text for contrast — same fix as
            // the destructive Generate button. Other states (green /
            // blue / red) read fine with white.
            color:
              output.state === "running"
                ? "var(--core-fleet-black)"
