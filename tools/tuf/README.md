...
For the full release process (releasing to edge, promoting to stable, patch releases, and other TUF components), see the [Releases](https://fleetdm.com/handbook/engineering/releases#fleetd-releases-macos-windows-linux) section of Fleet's engineering handbook.
