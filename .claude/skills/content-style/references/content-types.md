...
- Requires the case-study-specific meta tags (`summaryChallenge`, `summarySolution`, `summaryKeyResults`, company/quote tags) in addition to the standard article endmatter; the website build enforces these.
