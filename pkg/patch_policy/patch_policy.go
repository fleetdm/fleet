...
var windowsOpenQueryOverrides = map[string]string{ //nolint:gosec // G101 false positive: values are app process names, not credentials
	...
	"Adobe Acrobat Reader":              "IN ('acrord32.exe','acrobat.exe')",
	...
	"Genesys Cloud":                     "IN ('genesys cloud.exe','genesyscloud.exe')",
	...
	"Standard Notes":                    "= 'standard notes.exe'",
	"Sublime Text":                      "= 'sublime_text.exe'",
	"Tableau Desktop":                   "= 'tableau.exe'",
	"TeamViewer Host":                   "= 'teamviewer.exe'",
	"VirtualBox":                        "LIKE 'virtualbox%'",
	"Visual Studio Community 2022":      "= 'devenv.exe'",
	"Visual Studio Enterprise 2022":     "= 'devenv.exe'",
	"Visual Studio Professional 2022":   "= 'devenv.exe'",
