...
Manage your fleet with [GitOps](https://fleetdm.com/docs/configuration/yaml-files), or use the GUI, REST API, webhook events, and the fleetctl command-line tool.

#### Linux support
First-class support for all distros. Linux gets the same management, patching, and visibility as macOS and Windows.
...
## What's next?
Head over to [fleetdm.com](https://fleetdm.com) and try it out for yourself, or [grab time](https://fleetdm.com/contact) with one of the maintainers to chat.
