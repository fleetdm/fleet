## Fleet 4.8.0 (Dec 30, 2021)

* Update [Prometheus Go client library](https://github.com/prometheus/client_golang) which
  results in the following breaking changes to the [`GET /healthz` API
  route](https://fleetdm.com/docs/using-fleet/monitoring-fleet#health-checks):
