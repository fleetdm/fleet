...
e2e-setup:
	...
	./build/fleetctl setup --context e2e --email=admin@example.com --password=user123# --org-name='Fleet Test'
	./build/fleetctl user create --context e2e --email=maintainer@example.com --password=user123# --global-role=maintainer
	./build/fleetctl user create --context e2e --email=observer@example.com --password=user123# --global-role=observer
	./build/fleetctl user create --context e2e --email=sso_user@example.com --sso=true
