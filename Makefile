...
test-go: dump-test-schema generate-mock
	go test -tags full,fts5,netgo -coverprofile=coverage.txt ${GO_TEST_EXTRA_FLAGS_VAR} -parallel 8 -covermode=atomic -coverpkg=github.com/fleetdm/fleet/v4/... ./cmd/... ./ee/... ./orbit/pkg/... ./orbit/cmd/orbit ./pkg/... ./server/... ./tools/...
