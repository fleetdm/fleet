...
fleetd-tables-windows:
	GOOS=windows GOARCH=amd64 go build -o $@.exe ./orbit/cmd/fleetd_tables
fleetd-tables-linux:
	GOOS=linux GOARCH=amd64 go build -o $@.ext ./orbit/cmd/fleetd_tables
	sudo chown root $@.ext
	sudo chmod 744 $@.ext
fleetd-tables-darwin:
	GOOS=darwin GOARCH=amd64 go build -o $@.ext ./orbit/cmd/fleetd_tables
	sudo chown root $@.ext
	sudo chmod 744 $@.ext
fleetd-tables-darwin_arm:
	GOOS=darwin GOARCH=arm64 go build -o $@.ext ./orbit/cmd/fleetd_tables
	sudo chown root $@.ext
	sudo chmod 744 $@.ext
