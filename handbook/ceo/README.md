...
> **Note:** When the CEO is out of office, CEO responsibilities are either paused, delegated, or coordinated through the [Head of Digital Workplace & GTM Systems](https://fleetdm.com/handbook/it#team) so they can be handled promptly.  (It depends on the responsibility and the situation.)
