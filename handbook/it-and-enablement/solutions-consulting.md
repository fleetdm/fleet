...
This page documents processes and responsibilities for Solutions Consulting at Fleet. Solutions Consultants (SCs) play a critical role in our Go-To-Market (GTM) process, working closely with Account Executives (AEs), Account Development Representatives (ADRs), and prospects to understand use cases, provide technical guidance, and help move prospects toward becoming customers.

Solutions Consultants bridge the gap between technical capabilities and business needs, helping prospects understand how Fleet can solve their specific challenges while gathering insights that inform the sales process.
...
Solutions Consultants are part of Fleet's GTM groups:

- **🦄 Unicorns group**: Solutions Consultants work with AEs and other team members to provide the best possible customer experience for organizations with 700+ hosts
- See the [🦄 Go-To-Market groups](https://fleetdm.com/handbook/company/go-to-market-groups#current-gtm-groups) page for current Solutions Consultants and their assignments

## Outreach Guidelines

When reaching out to prospects or customers, Solutions Consultants follow these guidelines:

- **🐋 "Sales-ready" prospects**: The Account Executive (AE) determines the best way to contact the prospective customer, which is often the Solutions Consultant reaching out to help
- **🌦️ Customers**: Customer Success Managers (CSMs) handle customer outreach
- **🫧 Any other prospects**: Solutions Consultants reach out to prospects who are not yet sales-ready

## Working with ADRs and AEs

Solutions Consultants collaborate closely with Account Development Representatives (ADRs) and Account Executives (AEs):
...
<meta name="title" value="Solutions Consulting">
