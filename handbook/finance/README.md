...
5. Edit the new invoice to reflect details from the signed subscription agreement (and PO if required).
   ...
   - For invoices that are not on annual payment schedule, note the invoicing schedule and invoice amount in the notes section of the invoice, and update this [sheet](https://docs.google.com/spreadsheets/d/11kQNw6oTkPe_FCuRItZ26zBCGFOyxpF86XCJ335slxU/edit?gid=0#gid=0).
