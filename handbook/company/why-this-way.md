...
- **Engineers first.** We always talk to engineers first, and learn how it's going.  Security and IT engineers are the people closest to the work, and the people best positioned to know what they need to do their job. 
- **Leaders as well.** We also talk to the IT and Security leaders to learn their challenges.  The leaders are responsible for managing the company's investments, risks, and results. We learn how to partner with them to help them achieve their business results.
