...
> Currently, Fleet is only adding "Quick reference" to the [docs](fleetdm.com/docs). New "Committed learning" docs should be written as [articles](https://fleetdm.com/articles). Why? The docs surface area is large and hard to maintain. We've learned that users are more forgiving when articles are out-of-date.
