...
1. **Other open-source projects:** When we contribute to open-source projects owned by other people and organizations, we contribute to those outside repositories.  For example, Fleet contributes to [osquery](https://github.com/osquery/osquery/commits/master), [Sails.js](https://github.com/balderdashy/sails/commits/master), and [other open-source projects](https://github.com/orgs/fleetdm/sponsoring). If we need to layer our own unmerged changes on top of an actively maintained library, we do so [in a fork](https://github.com/fleetdm/fleet/blob/main/docs/Contributing/adr/0003-fork-management.md).
