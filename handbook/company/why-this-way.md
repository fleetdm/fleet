...
4. **Software vulnerabilities:** Since GitHub only allows one latest release per repoistory, we currently maintain two repositories to host our CVE/CPE database releases: 
