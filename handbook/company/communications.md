...
> **SOC2**
> Community members can [request a copy of Fleet's SOC 2 report](https://fleetdm.com/trust), in its current form, this SOC 2 report is intended to be shared only with parties who have signed a non-disclosure agreement with Fleet. Internal stakeholders can [contact IT & Enablement](https://fleetdm.com/handbook/it-and-enablement#contact-us) to locate Fleet's SOC 2 report in Google Drive.
