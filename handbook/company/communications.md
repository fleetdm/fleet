...
### Lodging
- Choose a modest location with inexpensive lodging and minimally-viable comfort. (For events, check the event's website for travel & hotel accommodations. As a general rule, do not spend more on lodging than the average listed hotel accommodations.)
