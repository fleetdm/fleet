...
Slack does not allow regular members or channel creators to convert a private channel to public. To convert a private channel to public, invite `@lppepper2` (Andrea Pepper), the [IT support administrator](https://fleetdm.com/handbook/it#team), to the channel and she will convert it.
