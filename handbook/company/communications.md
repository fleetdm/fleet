...
- **Confidentiality reminder.** Fleet meetings are considered public by default unless [otherwise specified](https://fleetdm.com/handbook/company/communications#levels-of-confidentiality). During a public meeting, if confidential information should be redacted from publication (such as YouTube, social media, etc.), please verbally say, "Pineapple, pineapple, pineapple." Videos are transcribed, and this makes it easier to find required redactions during the editing process before [upload](https://fleetdm.com/handbook/demand#upload-to-youtube).
  - **When sharing your screen** at a meeting, refrain from sharing sensitive information during screen shares. (Such as customer names, private messages, or other confidential information.)
