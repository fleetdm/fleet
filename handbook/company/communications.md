...
- If you have an open pull request, say in the pull request that you'll be out, and when you're back. A reviewer can't ask you questions while you're away. Picking up an unfinished change usually costs more than writing it fresh.
  - If the change isn't finished, move the pull request back to draft. That costs you nothing, and it keeps a reviewer from spending a pass on unfinished work.
  - If the change has to keep moving while you're out, find someone who agrees to take it over, and name them in the pull request. One left open without an owner waits until you're back.
  - Say this in the pull request, not only in Slack. The person who picks it up may not be the person you told.
