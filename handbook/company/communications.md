...
The idea here is to get this vision implemented on a single departmental handbook page first, starting with handbook/company/ceo.  That way we can iterate in one place instead of having things go a bunch of different directions.  Then once we've got that looking good and have iterated a bit, we'll spread it out.
