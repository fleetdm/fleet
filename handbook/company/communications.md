...
>
> Need help with Zoom? Reach out to 🌐 [IT & Enablement](https://fleetdm.com/handbook/it#contact-us).
...
If you ever make a mistake and need to delete something, you can delete the video in Gong or reach out to 🌐 [IT & Enablement](https://fleetdm.com/handbook/it#contact-us) for help. They will delete it immediately without watching the video. 
...
> Need a Calendly account? Reach out to 🌐 [IT & Enablement](https://fleetdm.com/handbook/it#contact-us).
...
Looking to add, change, or remove a shared calendar? [Create an issue](https://fleetdm.com/handbook/it#contact-us) and the appropriate DRI will reply with feedback.
...
> Please do not add events to the CEO's calendar. **Events added directly to the CEO's calendar will be declined and removed.** Even if the CEO asks you to set up a meeting or add him to a call, please get scheduling help from the [Executive Assistant](https://www.fleetdm.com/handbook/it#team)).
...
- **Why the extra step?** There are not enough hours in the day for the CEO to accept every request to meet, so [we have to prioritize](https://www.fleetdm.com/handbook/it#process-the-ceos-calendar).
...
> **Need an app that you don't see in Fleet Slack?** [Create a IT & Enablement issue](https://fleetdm.com/handbook/it#contact-us) to request an app be added to the Fleet Slack workspace.
...
The [IT & Enablement team](https://fleetdm.com/handbook/it#team) holds regular design review sessions to evaluate, revise, and approve wireframes before moving into production. Design review sessions are hosted by the [Head of Design](https://calendar.google.com/calendar/u/0?cid=bXRob21hc0BmbGVldGRtLmNvbQ) and typically take place daily, late afternoon (CT). Anyone is welcome to join.
...
- **Credit card limit increases:** The monthly limit on your Brex card may need to be increased temporarily as necessary to accommodate the increased spending associated with the conference, such as [booking your own travel](https://fleetdm.com/handbook/company/communications#flights).  You can [request that here](https://fleetdm.com/handbook/it#contact-us) by providing the following information:
...
When Fleeties relocate, there are vendors that need to be notified of the change. Before relocating, please create a [💼 Teammate relocation](https://github.com/fleetdm/confidential/issues/new?assignees=&labels=%23g-it-and-enablement&projects=&template=x-teammate-relocation.md) issue to [let the company know in advance](https://fleetdm.com/handbook/it#update-personnel-details) by following the directions listed in the relevant issue template.
...
If you are in need of IT support, reach out to 🌐 [IT & Enablement](https://fleetdm.com/handbook/it#contact-us) to assist with a software or hardware issue. [Open a support request](https://github.com/fleetdm/confidential/issues/new?assignees=&labels=%3Ahelp-it-and-enablement%2C%3Ait-gtm&projects=&template=1-custom-request.md&title=) and a Fleet IT team member will attempt to correct your issue remotely using Fleet, and will notify you if any action is needed on your part.
...
Please see 📖[handbook/it-and-enablement#check-production-dependencies-of-fleetdm-com](https://fleetdm.com/handbook/it#check-production-dependencies-of-fleetdm-com).

##### Testing changes
Please see 📖[handbook/it-and-enablement#test-fleetdm-com-locally](https://fleetdm.com/handbook/it#test-fleetdm-com-locally).
