...
- **Champion decisions.** Share your perspective openly, but once a [DRI](https://fleetdm.com/handbook/company/why-this-way#why-direct-responsibility) decides, champion that decision as if it were your own.  We all care about Fleet, and caring means different perspectives - that's healthy.  But alignment after the call is what makes us [fast](https://fleetdm.com/handbook/company#results).
