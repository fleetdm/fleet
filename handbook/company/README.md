...
- 🐈‍⬛ [CEO](https://fleetdm.com/handbook/ceo): The CEO is ultimately responsible for the success or failure of the company, as well as being the DRI for [mulitple aspects of the business](https://fleetdm.com/handbook/ceo#responsibilities). the "🦿 CEO Support team" is directly responsible for the framework behind Fleet's remote work culture, including handbook structure and content design, issue templates, key spreadsheets, project management processes, and other [decisions about how to work](https://fleetdm.com/handbook/company/why-this-way).
