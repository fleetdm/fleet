...
To do this, we choose an appropriate minor planet name from this [Wikipedia page](https://en.wikipedia.org/wiki/List_of_named_minor_planets_(alphabetical)) and create a label in the fleetdm/fleet and fleetdm/confidential repos which we attach to the issue and any future issues for this customer.

As part of the label description in the fleetdm/confidential repo, add the customer name. This way, we maintain a confidential mapping of codename to customer.
