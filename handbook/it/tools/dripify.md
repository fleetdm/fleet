...
Dripify is a LinkedIn automation and outreach platform used at Fleet for automating LinkedIn connection requests, follow-up messages, and engagement activities. It helps sales and marketing teams scale their LinkedIn outreach efforts while maintaining a personalized approach.

## Systems it integrates with

Dripify integrates with the following systems:

- **LinkedIn** - Direct integration with LinkedIn for connection requests, messages, and profile views
- **Salesforce** - Outreach data and contact information can be synced to Salesforce
- **LinkedIn Sales Navigator** - Works alongside Sales Navigator for enhanced targeting
...
- [Dripify Help Center](https://help.dripify.com/)
- Coordinate with the GTM team for outreach strategy
