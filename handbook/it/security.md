...
We strongly recommend using hardware security keys. Fleet configures privileged user accounts with a policy that enforces the use of hardware security keys. This prevents credential theft better than other methods of 2FA/2-SV. If you need a hardware security key, ask for help in [#help-it](https://fleetdm.slack.com/archives/C09861YJUJ2).
...
We recommend setting up security keys on your Google account for redundancy purposes. You can also configure your phone as an additional security key.

1. Set up your security key by following [Google's
...
2. Configure your phone as [a security key](https://support.google.com/accounts/answer/9289445)  


#### Optional: setting up security keys on GitHub

1. Configure your security keys to [access
