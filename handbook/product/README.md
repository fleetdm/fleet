...
User stories are clearly stated and easy to read. When user stories are unclear or don't match the discussed end result they will be placed into the "Needs clarity" column of the drafting board. The group product manager is then reassigned to rework the user story.
