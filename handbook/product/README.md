...
In cases where a designer needs more clarity on the requirements of a user story, they will place the issue ticket into the "needs clarity" column of the drafting board, assign the group product manager, and communicate the areas that require additional information. 
