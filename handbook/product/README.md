...
Product Designers [draft user stories](https://fleetdm.com/handbook/company/development-groups#drafting) that have been prioritized by PMs. If the estimated user stories for a product group exceed [that group's capacity](https://fleetdm.com/handbook/company/product-groups#current-product-groups), new drafting work for that group is paused, and the designer will contribute in other ways (documentation & handbook work, Figma maintenance, QA, etc.) until the PM deprioritizes estimated stories to make room, or until the next sprint begins. They may still begin work on prioritized [air guitar](https://fleetdm.com/handbook/company/product-groups#air-guitar) stories, which are not slated for implementation and don't affect sprint capacity.

> If the designer has existing work-in-progress when the next sprint reaches capacity, they will continue to review and iterate on those designs and see the stories through to estimation.
