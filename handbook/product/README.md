...
| Product confirm and celebrate                 | Weekly (Wednesday)       | The Head of Product meets with the designers and PMs to discuss completed epics. They also verify all updates to documentation, communications, guides, and the pricing and transparency pages, ensuring everything is set for the next steps.                                      | Mo Zhu            |
| Pre-sprint prioritization call (CX)           | Sprintly (Monday)        | The PM for CX meets with the EM for CX to confirm alignment on prioritization for the upcoming sprint.                                                                                                                                                                | Mo Zhu            |
| Bug review (CX)                               | Weekly (Tuesday)         | The PM for CX meets with the EM for CX and a Product Quality Engineer to ensure synchronization on bug prioritization and actions preceding CX estimation sessions.                                                                                                         | Mo Zhu            |
| Churned bug review                            | Sprintly (Wednesday)     | The Head of Product meets with the PMs to examine churned bugs and categorize them as either continue, needs prioritization, or de-prioritize.                                                                                                                                     | Mo Zhu            |
