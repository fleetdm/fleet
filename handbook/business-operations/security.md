...
| Allow specified actors to bypass required pull requests          | 🚫     | We do not want anyone pushing directly to main. The do not allow bypass setting should always be enabled in GitHub for SOC2 compliance.                                                                      |
