...
4. **Slack \#help-marketing.** Process boost requests (create a marketing board issue, then follow the [boost process](#how-to-boost-a-post)). CEO boost or RT requests are executed immediately.  
...
Pull CTR data for Evergreen (by segment, including audience penetration \- if a creative has been shown 10+ times and CTR is declining, pause or rebalance budget), Targeting Experiments (per experiment), and ABM (spend, delivery, empty campaigns). Then answer and document:
...
### Monthly (CMO \+ Content Specialist; CEO briefed through end of Q2 2026\)
