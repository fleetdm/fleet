...
The marketing team monitors and responds to comments on Fleet's company LinkedIn page posts daily. Comments on tracked posts are also surfaced in the [#social-media-comments](https://fleetdm.slack.com/archives/C0AP1FM3ES2) Slack channel. LinkedIn mentions are liked and comments are responded to where appropriate. Content related to GitOps certification or from Fleeties is reposted. Comments requiring subject-matter expertise are flagged to the appropriate team member for an answer before responding. All interactions are catalogued in Hootsuite for future reference.
