...
1. All computing environments and systems must be monitored in accordance to Fleet policies and procedures specified in the Fleet handbook.
...
* Reviewing analyzing and logging of all received reports and track their statuses.
...
* **Precursors** - A sign that an incident may occur in the future. Examples:
    ...
    * Suspicious emails targeting specific Fleet staff members with
...
3. The Head of Security determines if the issue is an Event, Precursor,
   ...
   1. If the issue is an event, indication, or precursor the Head of Security
      ...
      1. Non-Technical Event (minor infringement): the Head of Security of
...
2. A "lessons learned" section is written and attached to Incident ticket.
    ...
    1. Evaluate the cost and impact of the security incident to Fleet using
...
Fleet's expectation for them, relative to security responsibilities. The
...
4. Policy exceptions are handled on a case-by-case basis.
  ...
  * All policy exceptions must be approved by both Fleet Head of Security and CEO.
