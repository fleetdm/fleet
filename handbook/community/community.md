...
- Check whether the PR can be merged or needs to be reviewed by the Product team.
    ...
    - If a review is needed:
        - Request a review from the [Product DRI](./../people.md#directly-responsible-individuals). They should approve extensive changes and new features. Ask in the #g-product channel in Fleet's Slack for more information.
