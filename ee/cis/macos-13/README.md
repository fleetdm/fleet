...
These policies cover 96 of 104 CIS items that are able to be automated. For requirements and usage details, see the [CIS Benchmarks](https://fleetdm.com/docs/using-fleet/cis-benchmarks) documentation.
