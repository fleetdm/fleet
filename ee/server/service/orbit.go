...
func (svc *Service) GetOrbitSetupExperienceStatus(ctx context.Context, orbitNodeKey string, forceRelease bool) (*fleet.SetupExperienceStatusPayload, error) {
	...
	err = svc.failCancelledSetupExperienceInstalls(ctx, host.UUID, res)
	if err != nil {
...
func (svc *Service) failCancelledSetupExperienceInstalls(ctx context.Context, hostUUID string, results []*fleet.SetupExperienceStatusResult) error {
