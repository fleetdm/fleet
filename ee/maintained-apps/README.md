...
The bug filed should be:
- Added to the Drafting board > Ready to estimate column
- Labeled `#g-software`, `:incoming`, `:product`, and `bug`
- Assigned to the `#g-software` engineering manager
