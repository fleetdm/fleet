...
| `package_identifier`                  | Yes       | The `PackageIdentifier` from winget. Fleet uses this to pull the correct metadata for the app.                                                                                                                                                             |
...
| `fuzzy_match_name`       | No       | Fleet uses the app's name to match the package to inventoried software. If the TODO                                                        |
