# Locates Obsidian's NSIS uninstaller from the registry and runs it silently.
# Obsidian's NSIS DisplayName format includes the version, so match by prefix.

$displayNameLike = "Obsidian*"
$publisher = "Obsidian"
