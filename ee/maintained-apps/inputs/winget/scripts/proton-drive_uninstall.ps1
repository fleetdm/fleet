# Locates Proton Drive's uninstaller from the registry and runs it silently.
...
try {
Stop-Process -Name "Proton Drive" -Force -ErrorAction SilentlyContinue
