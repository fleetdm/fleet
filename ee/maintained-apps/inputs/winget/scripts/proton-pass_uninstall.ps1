# Locates Proton Pass's uninstaller from the registry and runs it silently.
...
try {
Stop-Process -Name "Proton Pass" -Force -ErrorAction SilentlyContinue
