# Locate VNC Viewer (RealVNC) in the uninstall registry by DisplayName + Publisher and
# run its MSI uninstaller silently. The DisplayName embeds the marketing version
# (e.g. "RealVNC Viewer 7.15.1"), so match by prefix. Publisher is "RealVNC".

$displayNamePattern = "RealVNC Viewer *"
$publisher = "RealVNC"
