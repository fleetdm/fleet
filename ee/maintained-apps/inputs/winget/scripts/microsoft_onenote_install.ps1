# Microsoft OneNote (Microsoft 365) - Install Script
# Installs OneNote via ODT, preserving any existing Office apps

$ErrorActionPreference = "Stop"

# Create working directory
$odtPath = "$env:TEMP\odt_onenote_$(Get-Random)"
...
try {
    ...
    # Build exclusion list - exclude everything EXCEPT OneNote and any existing apps
    $appsToInstall = @("OneNote") + $existingApps | Select-Object -Unique
