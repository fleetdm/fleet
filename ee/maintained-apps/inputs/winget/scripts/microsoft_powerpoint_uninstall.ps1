# Microsoft PowerPoint (Microsoft 365) - Uninstall Script
# Removes PowerPoint while preserving other Office apps

$ErrorActionPreference = "Stop"

$odtPath = "$env:TEMP\odt_powerpoint_uninstall_$(Get-Random)"
...
try {
    ...
    # Remove PowerPoint from the list of installed apps
    $appsToKeep = $existingApps | Where-Object { $_ -ne "PowerPoint" }
...
"@
        ...
        # Other apps exist - reconfigure to exclude PowerPoint
