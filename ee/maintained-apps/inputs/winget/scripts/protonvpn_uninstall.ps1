# Attempts to locate Proton VPN's Inno Setup uninstaller from the registry and run it silently.

$displayNameLike = "Proton VPN*"
$publisher = "Proton AG"
...
Stop-Process -Name "Proton VPN" -Force -ErrorAction SilentlyContinue
