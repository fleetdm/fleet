# Microsoft Access (Microsoft 365) - Install Script
# Installs Access via ODT, preserving any existing Office apps

$ErrorActionPreference = "Stop"

# Create working directory
$odtPath = "$env:TEMP\odt_access_$(Get-Random)"
...
try {
    ...
    # Build exclusion list - exclude everything EXCEPT Access and any existing apps
    $appsToInstall = @("Access") + $existingApps | Select-Object -Unique
