# Attempts to locate Insomnia's uninstaller from registry and execute it silently.
# Insomnia is a per-user Squirrel install — uninstall entry lives under HKCU.
...
Stop-Process -Name "Insomnia" -Force -ErrorAction SilentlyContinue
