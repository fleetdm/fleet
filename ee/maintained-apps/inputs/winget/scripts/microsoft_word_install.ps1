# Microsoft Word (Microsoft 365) - Install Script
# Installs Word via ODT, preserving any existing Office apps

$ErrorActionPreference = "Stop"

# Create working directory
$odtPath = "$env:TEMP\odt_word_$(Get-Random)"
...
try {
    ...
    # Build exclusion list - exclude everything EXCEPT Word and any existing apps
    $appsToInstall = @("Word") + $existingApps | Select-Object -Unique
