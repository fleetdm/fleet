# Attempts to locate NordPass's NSIS uninstaller from registry and execute it silently.

$displayNameLike = "NordPass*"
...
Stop-Process -Name "NordPass" -Force -ErrorAction SilentlyContinue
