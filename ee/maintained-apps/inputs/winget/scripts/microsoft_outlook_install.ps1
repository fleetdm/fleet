# Microsoft Outlook (Microsoft 365) - Install Script
# Installs Outlook via ODT, preserving any existing Office apps

$ErrorActionPreference = "Stop"

# Create working directory
$odtPath = "$env:TEMP\odt_outlook_$(Get-Random)"
...
try {
    ...
    # Build exclusion list - exclude everything EXCEPT Outlook and any existing apps
    $appsToInstall = @("Outlook") + $existingApps | Select-Object -Unique
