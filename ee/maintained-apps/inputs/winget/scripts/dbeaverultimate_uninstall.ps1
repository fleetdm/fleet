# Locates DBeaverUltimate's NSIS uninstaller from the registry and runs it silently.
# DBeaver NSIS DisplayName embeds the version (e.g. "DBeaverUltimate 26.0.0"), so
...
$displayNameLike = "DBeaverUltimate*"
