# Attempts to locate Sublime Merge's uninstaller from registry and execute it silently
...
# Kill any running Sublime Merge processes before uninstalling
Stop-Process -Name "sublime_merge" -Force -ErrorAction SilentlyContinue
Stop-Process -Name "smerge" -Force -ErrorAction SilentlyContinue
