...
# variable
# CloudShow registers DisplayName "CloudShow Launcher" with an arch suffix on 64-bit
# systems (e.g. "CloudShow Launcher (64-bit)"), so we match on the stable prefix.
$softwareName = "CloudShow Launcher"
