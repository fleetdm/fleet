# Microsoft Access (Microsoft 365) - Uninstall Script
# Removes Access while preserving other Office apps

$ErrorActionPreference = "Stop"

$odtPath = "$env:TEMP\odt_access_uninstall_$(Get-Random)"
...
try {
    ...
    # Remove Access from the list of installed apps
    $appsToKeep = $existingApps | Where-Object { $_ -ne "Access" }
...
"@
        ...
        # Other apps exist - reconfigure to exclude Access
