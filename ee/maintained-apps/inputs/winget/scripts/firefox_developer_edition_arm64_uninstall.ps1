...
# The ARM64 build registers as "Firefox Developer Edition (AArch64 en-US)"; matching
# on the architecture leaves an x64 Developer Edition on the same host alone.
$softwareNameLike = "$softwareName (AArch64 *"
