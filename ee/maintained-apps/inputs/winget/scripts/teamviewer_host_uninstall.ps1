# Locate TeamViewer Host in the uninstall registry by DisplayName + Publisher and run
# its MSI uninstaller silently. DisplayName is "TeamViewer Host", Publisher "TeamViewer".

$displayNamePattern = "TeamViewer Host"
