# Attempts to locate Appium Inspector's NSIS (electron-builder) uninstaller and run it silently.
# The registry DisplayName includes the version (e.g. "Appium Inspector 2026.5.1"), so match a prefix.

$displayName = "Appium Inspector"
...
Stop-Process -Name "Appium Inspector" -Force -ErrorAction SilentlyContinue
