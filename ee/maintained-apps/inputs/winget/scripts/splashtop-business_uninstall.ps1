# Uninstalls Splashtop Business.
#
# Splashtop Business installs via an embedded MSI with a stable ProductCode
# (per the winget manifest: {CD4EF8F2-8638-4A86-8C99-C585B3B47A25}). We try
...
$softwareNameLike = "Splashtop Business*"
