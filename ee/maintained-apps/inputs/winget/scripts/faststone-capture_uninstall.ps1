# Uninstalls FreeCAD.
#
# FastStone Capture (NSIS) registers a versioned DisplayName ("FastStone Capture <ver>") under HKLM,
# so match on the "FastStone Capture" prefix. Its uninst.exe supports /S for a silent
# uninstall.

$softwareNameLike = "FastStone Capture*"
