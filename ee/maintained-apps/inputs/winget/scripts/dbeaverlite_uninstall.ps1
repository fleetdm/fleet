# Locates DBeaverLite's NSIS uninstaller from the registry and runs it silently.
# DBeaver NSIS DisplayName embeds the version (e.g. "DBeaverLite 26.0.0"), so
