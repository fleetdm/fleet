# Locates Proton Mail Bridge's uninstaller from the registry and runs it silently.
...
$displayNameLike = "Proton Mail Bridge*"
$publisher = "Proton AG"
...
try {
Stop-Process -Name "bridge-gui" -Force -ErrorAction SilentlyContinue
