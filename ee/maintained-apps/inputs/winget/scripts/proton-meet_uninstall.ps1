# Locates Proton Meet's uninstaller from the registry and runs it silently.
...
try {
Stop-Process -Name "Proton Meet" -Force -ErrorAction SilentlyContinue
