# Uninstalls ImpExpPro (Inno Setup). Its ARP DisplayName is 'Benthic Software: ImpExpPro 1.x <arch>', so match by prefix.
$softwareNameLike = "Benthic Software: ImpExpPro 1.x*"
