# Microsoft Outlook (Microsoft 365) - Uninstall Script
# Removes Outlook while preserving other Office apps

$ErrorActionPreference = "Stop"

$odtPath = "$env:TEMP\odt_outlook_uninstall_$(Get-Random)"
...
try {
    ...
    # Remove Outlook from the list of installed apps
    $appsToKeep = $existingApps | Where-Object { $_ -ne "Outlook" }
...
"@
        ...
        # Other apps exist - reconfigure to exclude Outlook
