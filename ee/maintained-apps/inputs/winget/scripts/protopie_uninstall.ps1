# Locates ProtoPie's uninstaller from the registry and runs it silently.
...
$displayNameLike = "ProtoPie*"
$publisher = "Studio XID, Inc."
...
try {
Stop-Process -Name "ProtoPie" -Force -ErrorAction SilentlyContinue
