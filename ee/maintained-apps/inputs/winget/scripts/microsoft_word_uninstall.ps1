# Microsoft Word (Microsoft 365) - Uninstall Script
# Removes Word while preserving other Office apps

$ErrorActionPreference = "Stop"

$odtPath = "$env:TEMP\odt_word_uninstall_$(Get-Random)"
...
try {
    ...
    # Remove Word from the list of installed apps
    $appsToKeep = $existingApps | Where-Object { $_ -ne "Word" }
...
"@
        ...
        # Other apps exist - reconfigure to exclude Word
