# Uninstalls Gpg4win. Its ARP DisplayName carries the version (e.g.
# "Gpg4win (5.0.2)"), so match by prefix; QuietUninstallString runs
# gpg4win-uninstall.exe /S.

$softwareNameLike = "Gpg4win*"
