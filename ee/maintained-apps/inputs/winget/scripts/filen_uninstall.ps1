# Attempts to locate Filen's NSIS (electron-builder) uninstaller and run it silently.
# Filen is user-scope; the registry DisplayName may be "Filen" or "Filen Sync", so match a prefix.
...
Stop-Process -Name "Filen" -Force -ErrorAction SilentlyContinue
