# Attempts to locate Lens's NSIS uninstaller from registry and execute it silently.

$displayNameLike = "Lens*"
...
Stop-Process -Name "Lens" -Force -ErrorAction SilentlyContinue
