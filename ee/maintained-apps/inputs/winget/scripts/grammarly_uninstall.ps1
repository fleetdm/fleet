# Attempts to locate Grammarly's NSIS uninstaller from registry and execute it silently.

$displayNameLike = "Grammarly*"
...
Stop-Process -Name "Grammarly" -Force -ErrorAction SilentlyContinue
