# Attempts to locate GitKraken's uninstaller from registry and execute it silently.
# GitKraken is a per-user Squirrel install — uninstall entry lives under HKCU.
...
Stop-Process -Name "GitKraken" -Force -ErrorAction SilentlyContinue
