# Attempts to locate draw.io's NSIS uninstaller from registry and execute it silently.

$displayNameLike = "draw.io*"
$publisher = "JGraph"
...
Stop-Process -Name "draw.io" -Force -ErrorAction SilentlyContinue
