# Microsoft PowerPoint (Microsoft 365) - Install Script
# Installs PowerPoint via ODT, preserving any existing Office apps

$ErrorActionPreference = "Stop"

# Create working directory
$odtPath = "$env:TEMP\odt_powerpoint_$(Get-Random)"
...
try {
    ...
    # Build exclusion list - exclude everything EXCEPT PowerPoint and any existing apps
    $appsToInstall = @("PowerPoint") + $existingApps | Select-Object -Unique
