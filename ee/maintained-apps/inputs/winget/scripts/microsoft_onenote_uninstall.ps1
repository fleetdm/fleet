# Microsoft OneNote (Microsoft 365) - Uninstall Script
# Removes OneNote while preserving other Office apps

$ErrorActionPreference = "Stop"

$odtPath = "$env:TEMP\odt_onenote_uninstall_$(Get-Random)"
...
try {
    ...
    # Remove OneNote from the list of installed apps
    $appsToKeep = $existingApps | Where-Object { $_ -ne "OneNote" }
...
"@
        ...
        # Other apps exist - reconfigure to exclude OneNote
