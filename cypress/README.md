...
With the roll out of teams, Cypress tests the user interface of each role of a user on the Basic Tier ([Fleet Premium Documentation](integration/basic/README.md)) and Core Tier ([Fleet Free Documentation](integration/basic/README.md)).
