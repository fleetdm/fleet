describe('Query flow', () => {
    ...
    it('Create, check, edit, and delete a query successfully', () => {
        ...
        cy.get('.ace_content').type('{selectall}{backspace}SELECT * FROM windows_crashes;')
        .click();
        ...
        cy.contains('button', /save as new/i)
        .click();
        ...
        cy.get('.queries-list-row__name')
        .click();

        cy.contains('button', /edit or run query/i)
        .click();

        cy.get('.ace_content').type('{selectall}{backspace}SELECT datetime, username FROM windows_crashes;')
        .click();
        ...
        cy.get('.manage-queries-page__modal-btn-wrap > .button--alert').contains('button', /delete/i)
        .click();
