...
To preprare your hosts for migration, you must [enroll](https://fleetdm.com/guides/enroll-hosts) them to Fleet with [Fleetd and Fleet Desktop](https://fleetdm.com/guides/enroll-hosts#fleet-desktop).
...
6. Send [these guided instructions](#how-to-turn-on-mdm-end-user-1) to your end users to complete the final few steps via Fleet Desktop.
